!(function (t, e) {
	...
	function i(t) {
		...
		for (var n = 0; n < t.length; n++) {
			var i = String.fromCharCode(n + 32),
				r = (t.charCodeAt(n) - jy) / Zy;
			e[i] = r;
		}
		return e;
	}
	function r(t) {
		for (var e in Qy) t[e] && (Qy[e] = t[e]);
	}
	function o() {
		return hm++;
	}
	...
	function s(t) {
		...
		} else if (!Jy[n] && !X(t) && !L(t)) {
			e = {};
			for (var a in t) t.hasOwnProperty(a) && a !== um && (e[a] = s(t[a]));
		}
		return e;
	}
	function l(t, e, n) {
	...
	function h(t, e) {
		...
		else for (var n in e) e.hasOwnProperty(n) && n !== um && (t[n] = e[n]);
		return t;
	}
	function c(t, e, n) {
	...
	function v(t, e, n) {
		if (t && e)
			if (t.forEach && t.forEach === im) t.forEach(e, n);
	...
	function y(t, e, n) {
		if (!t) return [];
		if (!e) return V(t);
		if (t.map && t.map === am) return t.map(e, n);
	...
	function _(t, e, n) {
		if (!t) return [];
		if (!e) return V(t);
		if (t.filter && t.filter === rm) return t.filter(e, n);
	...
	function b(t, e) {
		...
		return function () {
			return t.apply(e, n.concat(om.call(arguments)));
		};
	}
	function S(t) {
		for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
		return function () {
			return t.apply(this, e.concat(om.call(arguments)));
		};
	}
	function M(t) {
		return Array.isArray ? Array.isArray(t) : '[object Array]' === em.call(t);
	}
	function T(t) {
	...
	function I(t) {
		return '[object String]' === em.call(t);
	}
	function D(t) {
	...
	function E(t) {
		return '[object RegExp]' === em.call(t);
	}
	function z(t) {
		return t !== t;
	}
	...
	function xe(t, e, n, i, r, o) {
		...
		for (var c = 0, p = 0, f = 0; s > p; p++) {
			var d = 1 << p;
			d & r || ((c += (f % 2 ? -1 : 1) * t[n][p] * xe(t, e - 1, h, u, r | d, o)), f++);
		}
		return (o[a] = c), c;
	}
	function we(t, e) {
		...
		if (0 !== r) {
			for (var o = [], a = 0; 8 > a; a++)
				for (var s = 0; 8 > s; s++)
					null == o[s] && (o[s] = 0),
						(o[s] +=
							((((a + s) % 2 ? -1 : 1) * xe(n, 7, 0 === a ? 1 : 0, 1 << a, 1 << s, i)) / r) * e[a]);
	...
	function be(t, e, n, i, r) {
		return Se(km, e, i, r, !0) && Se(t, n, km[0], km[1]);
	}
	function Se(t, e, n, i, r) {
		if (e.getBoundingClientRect && Uy.domSupported && !Ce(e)) {
			var o = e[Dm] || (e[Dm] = {}),
				a = Me(e, o),
				s = Te(a, o, r);
	...
	function De(t, e, n, i) {
		return (
			...
			i
				? ke(t, e, n)
				: Rm && null != e.layerX && e.layerX !== e.offsetX
	...
	function ke(t, e, n) {
		if (Uy.domSupported && t.getBoundingClientRect) {
			var i = e.clientX,
				r = e.clientY;
			if (Ce(t)) {
			...
			if (Se(Om, t, i, r)) return (n.zrX = Om[0]), void (n.zrY = Om[1]);
		}
		n.zrX = n.zrY = 0;
	}
	function Ae(t) {
	...
	function Ze(t, e, n, i, r) {
		for (var o = t.length - 1; o >= 0; o--) {
			...
			if (
				...
				!a.ignore &&
				(s = je(a, n, i)) &&
				(!e.topTarget && (e.topTarget = a), s !== Zm)
			) {
				e.target = a;
				break;
			}
	...
	function on(t, e, n, i) {
		...
		if (!(2 > r)) {
			var o = 0;
			if (n_ > r) return (o = Qe(t, n, i, e)), void tn(t, n, i, n + o, e);
			var a = rn(t, e),
				s = $e(r);
			do {
				if (((o = Qe(t, n, i, e)), s > o)) {
		...
		if (ln(h) && ln(c))
			...
			if (ln(g)) {
				...
				var m = p_(g),
					_ = h * s + 1.5 * a * (-c + m),
					x = h * s + 1.5 * a * (-c - m);
				(_ = 0 > _ ? -c_(-_, v_) : c_(_, v_)), (x = 0 > x ? -c_(-x, v_) : c_(x, v_));
				var d = (-s - (_ + x)) / (3 * a);
				d >= 0 && 1 >= d && (o[f++] = d);
			} else {
				var w = (2 * h * s - 3 * a * c) / (2 * p_(h * h * h)),
					b = Math.acos(w) / 3,
					S = p_(h),
					M = Math.cos(b),
					d = (-s - 2 * S * M) / (3 * a),
					y = (-s + S * (M + g_ * Math.sin(b))) / (3 * a),
					T = (-s + S * (M - g_ * Math.sin(b))) / (3 * a);
				d >= 0 && 1 >= d && (o[f++] = d),
					y >= 0 && 1 >= y && (o[f++] = y),
					T >= 0 && 1 >= T && (o[f++] = T);
			}
	...
	function gn(t, e, n, i, r, o, a, s, l, u, h) {
		...
		return h && ((h[0] = hn(t, n, r, a, c)), (h[1] = hn(e, i, o, s, c))), p_(y);
	}
	...
	function bn(t, e, n, i, r, o, a, s, l) {
		var u,
			h = 0.005,
			c = 1 / 0;
		(y_[0] = a), (y_[1] = s);
		for (var p = 0; 1 > p; p += 0.05) {
			(m_[0] = yn(t, n, r, p)), (m_[1] = yn(e, i, o, p));
			var f = bm(y_, m_);
			c > f && ((u = p), (c = f));
		}
		c = 1 / 0;
		for (var d = 0; 32 > d && !(d_ > h); d++) {
			var g = u - h,
				v = u + h;
			(m_[0] = yn(t, n, r, g)), (m_[1] = yn(e, i, o, g));
			var f = bm(m_, y_);
			if (g >= 0 && c > f) (u = g), (c = f);
			else {
				(__[0] = yn(t, n, r, v)), (__[1] = yn(e, i, o, v));
				var y = bm(__, y_);
				1 >= v && c > y ? ((u = v), (c = y)) : (h *= 0.5);
			}
		}
		return l && ((l[0] = yn(t, n, r, u)), (l[1] = yn(e, i, o, u))), p_(c);
	}
	...
	function Rn(t, e) {
		I_ && On(I_, e), (I_ = C_.put(t, I_ || e.slice()));
	}
	function En(t, e) {
		if (t) {
			e = e || [];
			...
			if (i in T_) return On(e, T_[i]), Rn(t, e), e;
			var r = i.length;
			if ('#' !== i.charAt(0)) {
				var o = i.indexOf('('),
					a = i.indexOf(')');
				if (-1 !== o && a + 1 === r) {
					...
					switch (s) {
						case 'rgba':
							if (4 !== l.length)
								return 3 === l.length ? Ln(e, +l[0], +l[1], +l[2], 1) : Ln(e, 0, 0, 0, 1);
							u = kn(l.pop());
						case 'rgb':
							return l.length >= 3
	...
	function fi(t, e) {
		var n = e.domHandlers;
		Uy.pointerEventsSupported
			? v(X_.pointer, function (i) {
					gi(e, i, function (e) {
						n[i].call(t, e);
					});
			  })
			: (Uy.touchEventsSupported &&
					v(X_.touch, function (i) {
						gi(e, i, function (r) {
							n[i].call(t, r), ui(e);
						});
					}),
			  v(X_.mouse, function (i) {
					gi(e, i, function (r) {
	...
	function di(t, e) {
		...
		Uy.pointerEventsSupported ? v(Y_.pointer, n) : Uy.touchEventsSupported || v(Y_.mouse, n);
	}
	function gi(t, e, n, i) {
	...
	function _i(t, e) {
		...
		n || (n = fx[e] = new M_(500));
		var i = n.get(t);
		return null == i && ((i = Qy.measureText(t, e).width), n.put(t, i)), i;
	}
	function xi(t, e, n, i) {
		var r = _i(t, e),
			o = Mi(e),
	...
	function wi(t, e, n, i) {
		...
		for (var a = new jm(0, 0, 0, 0), s = 0; s < r.length; s++) {
			var l = xi(r[s], e, n, i);
	...
	function Ci(t, e, n) {
		...
		if (i instanceof Array)
			(l += Ti(i[0], n.width)), (u += Ti(i[1], n.height)), (h = null), (c = null);
		else
			switch (i) {
				case 'left':
	...
	function Ei(t) {
		if (!t) return !1;
		if ('string' == typeof t) return Xn(t, 1) < ex;
		if (t.colorStops) {
	...
	function Ni() {
		for (var t in Sx) Sx.hasOwnProperty(t) && Sx[t].dispose();
		Sx = {};
	}
	function Fi(t) {
		return Sx[t];
	...
	function Ui(t, e, n) {
		return (
			null == e && (e = 10), (e = Math.min(Math.max(0, e), Dx)), (t = (+t).toFixed(e)), n ? t : +t
		);
	}
	function Xi(t) {
		return (
	...
	function yr(t, e, n) {
		...
		var s = mr(t, a, n);
		return (
			(i || r) && _r(s, t, a, e), i && xr(s, e), i || r ? wr(s, e, r) : o && br(s, e), Sr(s), s
		);
	}
	function mr(t, e, n) {
		var i = [];
		...
		for (var r = 0; r < t.length; r++) {
			...
			o && null != o.id && e.set(o.id, r),
				i.push({
					existing: 'replaceMerge' === n || Dr(o) ? null : o,
					newOption: null,
					keyInfo: null,
					brandNew: null
				});
		...
		v(e, function (e) {
			if (e) {
				for (
					...
					(i.newOption ||
						Dr(i.existing) ||
						(i.existing && null != e.id && !Mr('id', e, i.existing)));
		...
		v(t, function (t) {
			...
			v(t, function (t, n) {
				var i = t.existing,
					...
					o = t.keyInfo;
				if (k(r)) {
					if (((o.name = null != r.name ? Tr(r.name) : i ? i.name : Px + n), i)) o.id = Tr(i.id);
	...
	function Ir(t) {
		var e = t.name;
		return !(!e || !e.indexOf(Px));
	}
	function Dr(t) {
		return t && null != t.id && 0 === Tr(t.id).indexOf(Lx);
	}
	function kr(t, e, n) {
		v(t, function (t) {
			var i = t.newOption;
	...
	function Er(t, e, n, i) {
		...
		return 'none' === r || r === !1
			? (G(i.enableNone, '`"none"` or `false` is not a valid value on index option.'),
			  (s.models = []),
			  s)
			: ('all' === r &&
					(G(i.enableAll, '`"all"` is not a valid value on index option.'), (r = o = a = null)),
	...
	function Nr(t) {
		return 'auto' === t ? (Uy.domSupported ? 'html' : 'richText') : t || 'html';
	}
		...
		for (var s = [], l = n, u = i, h = Math.max(l ? l.length : 0, u.length), c = 0; h > c; ++c) {
			...
			if (p && 'ordinal' === p.type) s[c] = (1 > r && l ? l : u)[c];
				...
				var f = l && l[c] ? l[c] : 0,
					d = u[c],
					a = pr(f, d, r);
				s[c] = Ui(a, o ? Math.max(Yi(f), Yi(d)) : e);
			}
		}
		return s;
	}
	...
	function Zr(t) {
		function e(t) {
			var e = n[t.main];
			return (e && e[Bx]) || ((e = n[t.main] = {}), (e[Bx] = !0)), e;
		}
		var n = {};
			...
			if ('string' == typeof t) {
				...
				return (
					o
						...
						: ((e = Qy.loadImage(t, Jr, Jr)),
						  (e.__zrImageSrc = t),
						  Wx.put(t, (e.__cachedImgObj = { image: e, pending: [a] }))),
					e
				);
			}
			return t;
	...
	function io(t, e) {
		...
		for (var a = 0; ; a++) {
			...
			var s =
				0 === a
					? ro(t, r, e.ascCharWidth, e.cnCharWidth)
					: o > 0
	...
	function oo(t, e) {
		...
		if (t && a && null != c)
			for (
				var g = no(c, o, e.ellipsis, { minChar: e.truncateMinChar, placeholder: e.placeholder }),
					v = 0;
				v < n.length;
				v++
			)
				n[v] = io(n[v], g);
		for (var y = f, m = 0, v = 0; v < n.length; v++) m = Math.max(_i(n[v], o), m);
		null == c && (c = m);
		var _ = m;
		return (
	...
	function ao(t, e) {
		...
		for (
			...
			var h = r.index;
			h > u && so(i, t.substring(u, h), e, l), so(i, r[2], e, l, r[1]), (u = Ux.lastIndex);
		}
		...
		t: for (var y = 0; y < i.lines.length; y++) {
			for (var m = i.lines[y], _ = 0, x = 0, w = 0; w < m.tokens.length; w++) {
				...
				if ('string' == typeof D && '%' === D.charAt(D.length - 1))
					(b.percentWidth = D), c.push(b), (b.contentWidth = _i(b.text, C));
				else {
					if (k) {
						var A = S.backgroundColor,
							P = A && A.image;
						P && ((P = $r(P)), to(P) && (b.width = Math.max(b.width, (P.width * I) / P.height)));
					}
					var L = g && null != o ? o - x : null;
					null != L && L < b.width
						? !k || T > L
							? ((b.text = ''), (b.width = b.contentWidth = 0))
							: ((b.text = eo(b.text, L - T, C, e.ellipsis, { minChar: e.truncateMinChar })),
							  (b.width = b.contentWidth = _i(b.text, C)))
						: (b.contentWidth = _i(b.text, C));
				}
	...
	function so(t, e, n, i, r) {
		...
		for (var v = 0; v < o.length; v++) {
			...
			if (
				...
				var _ = (u[u.length - 1] || (u[0] = new Yx())).tokens,
					x = _.length;
	...
	function po(t, e, n, i, r, o) {
		(r[0] = iw(t, n)), (r[1] = iw(e, i)), (o[0] = rw(t, n)), (o[1] = rw(e, i));
	}
	function fo(t, e, n, i, r, o, a, s, l, u) {
		...
		for (var f = 0; p > f; f++) {
			var d = c(t, n, r, a, cw[f]);
			(l[0] = iw(d, l[0])), (u[0] = rw(d, u[0]));
		}
		p = h(e, i, o, s, pw);
		for (var f = 0; p > f; f++) {
			var g = c(e, i, o, s, pw[f]);
			(l[1] = iw(g, l[1])), (u[1] = rw(g, u[1]));
		}
		(l[0] = iw(t, l[0])),
			(u[0] = rw(t, u[0])),
			(l[0] = iw(a, l[0])),
	...
	function go(t, e, n, i, r, o, a, s) {
		var l = xn,
			...
			p = u(t, n, r, h),
			f = u(e, i, o, c);
		(a[0] = iw(t, r, p)), (a[1] = iw(e, o, f)), (s[0] = rw(t, r, p)), (s[1] = rw(e, o, f));
	}
	function vo(t, e, n, i, r, o, a, s, l) {
		...
		for (var f = 0; o > f; f += Math.PI / 2)
			f > r && ((hw[0] = aw(f) * n + t), (hw[1] = ow(f) * i + e), u(s, hw, s), h(l, hw, l));
	}
	function yo(t) {
		var e = Math.round((t / Tw) * 1e8) / 1e8;
		return (e % 2) * Tw;
	}
	function mo(t, e) {
		var n = yo(t[0]);
	...
	function wo(t, e, n, i, r, o, a, s, l) {
		...
		if (
			...
			return !1;
		var h = bn(t, e, n, i, r, o, s, l, null);
		return u / 2 >= h;
	}
	function bo(t) {
		return (t %= Aw), 0 > t && (t += Aw), t;
	}
	function So(t, e, n, i, r, o, a, s, l) {
		...
		if (Math.abs(i - r) % Pw < 1e-4) return !0;
		if (o) {
			var c = i;
			(i = bo(r)), (r = bo(c));
		} else (i = bo(i)), (r = bo(r));
		...
		return 0 > p && (p += Pw), (p >= i && r >= p) || (p + Pw >= i && r >= p + Pw);
	}
	...
	function Ao(t, e, n, i, r) {
		for (var o, a, s = t.data, l = t.len(), u = 0, h = 0, c = 0, p = 0, f = 0, d = 0; l > d; ) {
			...
			switch (
				...
				case Lw.L:
					if (n) {
						if (_o(h, c, s[d], s[d + 1], e, i, r)) return !0;
					} else u += Mo(h, c, s[d], s[d + 1], i, r) || 0;
					(h = s[d++]), (c = s[d++]);
					break;
				case Lw.C:
					if (n) {
						if (xo(h, c, s[d++], s[d++], s[d++], s[d++], s[d], s[d + 1], e, i, r)) return !0;
					} else u += Io(h, c, s[d++], s[d++], s[d++], s[d++], s[d], s[d + 1], i, r) || 0;
					(h = s[d++]), (c = s[d++]);
					break;
				case Lw.Q:
					if (n) {
						if (wo(h, c, s[d++], s[d++], s[d], s[d + 1], e, i, r)) return !0;
					} else u += Do(h, c, s[d++], s[d++], s[d], s[d + 1], i, r) || 0;
					(h = s[d++]), (c = s[d++]);
					break;
				case Lw.A:
					var y = s[d++],
					...
					(o = Math.cos(w) * _ + y),
						(a = Math.sin(w) * x + m),
						v ? ((p = o), (f = a)) : (u += Mo(h, c, o, a, i, r));
					var M = ((i - y) * x) / _ + y;
					if (n) {
						if (So(y, m, x, w, w + b, S, e, M, r)) return !0;
					} else u += ko(y, m, x, w, w + b, S, M, r);
				...
				case Lw.R:
					...
					if (((o = p + T), (a = f + C), n)) {
						if (
							...
							return !0;
					} else (u += Mo(o, f, o, a, i, r)), (u += Mo(p, a, p, f, i, r));
					break;
				case Lw.Z:
					if (n) {
						if (_o(h, c, p, f, e, i, r)) return !0;
					} else u += Mo(h, c, p, f, i, r);
					(h = p), (c = f);
			}
		}
		return n || To(c, f) || (u += Mo(h, c, p, f, i, r) || 0), 0 !== u;
	}
	function Po(t, e, n) {
		return Ao(t, 0, !1, e, n);
	}
	...
	function Eo(t, e, n) {
		if (e) {
			...
			var s = n && n.lineWidth;
			return s
				? (Yw(2 * i) === Yw(2 * r) && (t.x1 = t.x2 = Bo(i, s, !0)),
				  Yw(2 * o) === Yw(2 * a) && (t.y1 = t.y2 = Bo(o, s, !0)),
				  t)
				: t;
		}
	}
	...
	function Bo(t, e, n) {
		if (!e) return t;
		var i = Yw(2 * t);
		return (i + Yw(e)) % 2 === 0 ? i / 2 : (i + (n ? 1 : -1)) / 2;
	}
	function No(t) {
		return 'string' != typeof t ||
	...
	function Go(t) {
		if (t) {
			t.font = Jw.makeFont(t);
			var e = t.align;
			'middle' === e && (e = 'center'), (t.align = null == e || tb[e] ? e : 'left');
			var n = t.verticalAlign;
			'center' === n && (n = 'middle'), (t.verticalAlign = null == n || eb[n] ? n : 'top');
			var i = t.padding;
	...
	function Zo(t) {
		if (C(t)) {
			var e = wb.get(t);
			return e || ((e = Nn(t, -0.1)), wb.put(t, e)), e;
		}
		if (O(t)) {
			var n = h({}, t);
			return (
	...
	function Qo(t) {
		t.hoverState === cb && Ko(t, 'normal', ub);
	}
	function Jo(t) {
		Ko(t, 'blur', hb);
	}
	function ta(t) {
		t.hoverState === hb && Ko(t, 'normal', ub);
	}
	function ea(t) {
		t.selected = !0;
	}
			...
			o.eachSeries(function (t) {
				...
				if (
					...
					if (
						...
						r(t.getData(), e);
					else if (k(e)) for (var p = w(e), f = 0; f < p.length; f++) r(t.getData(p[f]), e[p[f]]);
					l.push(t), (lb(t).isBlured = !0);
				}
			}),
	...
	function Ca(t, e, n) {
		...
		o
			...
			: (ba(i.seriesIndex, i.focus, i.blurScope, n),
	...
	function Da(t, e) {
		if (Fa(e)) {
			var n = e.dataType,
				...
				r = Pr(i, e);
			M(r) || (r = [r]),
				t[e.type === xb ? 'toggleSelect' : e.type === mb ? 'select' : 'unselect'](r, n);
		}
	}
	function ka(t) {
		var e = t.getAllData();
	...
	function Ea(t, e, n, i) {
		n = n || 'itemStyle';
		for (var r = 0; r < bb.length; r++) {
			var o = bb[r],
				a = e.getModel([o, n]),
				s = t.ensureState(o);
			s.style = i ? i(a) : a[Sb[n]]();
		}
	}
	function za(t, e) {
		var n = e === !1,
	...
	function Na(t) {
		var e = ab[t];
		return null == e && 32 >= ob && (e = ab[t] = ob++), e;
	}
	function Fa(t) {
		var e = t.type;
		return e === mb || e === _b || e === xb;
	}
	function Va(t) {
		var e = t.type;
		return e === vb || e === yb;
			...
			for (r = 0, o = 0; u > r; ) {
				switch (((n = l[r++]), (o = r), (i = 0), n)) {
					...
					case d:
						var v = e[4],
							y = e[5],
							m = Cb(e[0] * e[0] + e[1] * e[1]),
							_ = Cb(e[2] * e[2] + e[3] * e[3]),
							x = Ib(-e[1] / _, e[0] / m);
						(l[r] *= m),
							(l[r++] += v),
							(l[r] *= _),
	...
	function Ya(t, e, n, i, r, o, a, s, l, u, h) {
		var c = l * (Pb / 180),
			p = (Ab(c) * (t - n)) / 2 + (kb(c) * (e - i)) / 2,
			f = (-1 * kb(c) * (t - n)) / 2 + (Ab(c) * (e - i)) / 2,
			d = (p * p) / (a * a) + (f * f) / (s * s);
		d > 1 && ((a *= Db(d)), (s *= Db(d)));
		var g =
				(r === o ? -1 : 1) *
					Db((a * a * s * s - a * a * f * f - s * s * p * p) / (a * a * f * f + s * s * p * p)) ||
				0,
			v = (g * a * f) / s,
			y = (g * -s * p) / a,
			m = (t + n) / 2 + Ab(c) * v - kb(c) * y,
			_ = (e + i) / 2 + kb(c) * v + Ab(c) * y,
			x = Xa([1, 0], [(p - v) / a, (f - y) / s]),
			w = [(p - v) / a, (f - y) / s],
			b = [(-1 * p - v) / a, (-1 * f - y) / s],
			S = Xa(w, b);
		if ((Ua(w, b) <= -1 && (S = Pb), Ua(w, b) >= 1 && (S = 0), 0 > S)) {
			var M = Math.round((S / Pb) * 1e6) / 1e6;
			S = 2 * Pb + (M % 2) * Pb;
		}
	...
	function qa(t) {
		...
		for (var u = 0; u < l.length; u++) {
			for (
				var h = l[u], c = h.charAt(0), p = void 0, f = h.match(Ob) || [], d = f.length, g = 0;
				d > g;
				g++
			)
				f[g] = parseFloat(f[g]);
	...
	function Ja(t, e, n, i, r, o, a, s) {
		var l = n - t,
			...
			c = s - o,
			p = c * l - h * u;
		return Zb > p * p ? void 0 : ((p = (h * (e - o) - c * (t - r)) / p), [t + p * l, e + p * u]);
	}
	...
	function ns(t, e) {
		...
		if (o || a) {
			...
			if (!isNaN(l) && !isNaN(u)) {
				...
				if ((d > Zb && (f = d), i > Zb))
					if (f > Vb - Zb)
						t.moveTo(h + i * Gb(l), c + i * Hb(l)),
							t.arc(h, c, i, l, u, !p),
							r > Zb && (t.moveTo(h + r * Gb(u), c + r * Hb(u)), t.arc(h, c, r, u, l, p));
					else {
						var g = void 0,
							v = void 0,
							y = void 0,
						...
						if (E) {
							...
							if (
								...
								(C = M = qb(w, b)),
								(S > Zb || M > Zb) &&
									((I = i * Gb(u)), (D = i * Hb(u)), (k = r * Gb(l)), (A = r * Hb(l)), Fb > f))
							) {
								...
								if (N) {
									var F = P - N[0],
										...
										H = I - N[0],
										G = D - N[1],
										W = 1 / Hb(Wb((F * H + V * G) / (Yb(F * F + V * V) * Yb(H * H + G * G))) / 2),
										U = Yb(N[0] * N[0] + N[1] * N[1]);
									(T = jb(S, (i - U) / (W + 1))), (C = jb(M, (r - U) / (W - 1)));
								}
							}
						}
						if (E)
							if (T > Zb) {
								...
								t.moveTo(h + q.cx + q.x0, c + q.cy + q.y0),
									S > T && X === Y
										? t.arc(h + q.cx, c + q.cy, T, Ub(q.y0, q.x0), Ub(j.y0, j.x0), !p)
										: (X > 0 && t.arc(h + q.cx, c + q.cy, X, Ub(q.y0, q.x0), Ub(q.y1, q.x1), !p),
										  t.arc(
												h,
												c,
												i,
												Ub(q.cy + q.y1, q.cx + q.x1),
												Ub(j.cy + j.y1, j.cx + j.x1),
												!p
										  ),
										  Y > 0 && t.arc(h + j.cx, c + j.cy, Y, Ub(j.y1, j.x1), Ub(j.y0, j.x0), !p));
						...
						if (r > Zb && E)
							if (C > Zb) {
								...
								t.lineTo(h + q.cx + q.x0, c + q.cy + q.y0),
									M > C && X === Y
										? t.arc(h + q.cx, c + q.cy, C, Ub(q.y0, q.x0), Ub(j.y0, j.x0), !p)
										: (Y > 0 && t.arc(h + q.cx, c + q.cy, Y, Ub(q.y0, q.x0), Ub(q.y1, q.x1), !p),
										  t.arc(h, c, r, Ub(q.cy + q.y1, q.cx + q.x1), Ub(j.cy + j.y1, j.cx + j.x1), p),
										  X > 0 && t.arc(h + j.cx, c + j.cy, X, Ub(j.y1, j.x1), Ub(j.y0, j.x0), !p));
	...
	function _s(t, e, n, i) {
		var r = Ka(t, e);
		return n && ('center' === i && (n = ws(n, r.getBoundingRect())), bs(r, n)), r;
	}
	function xs(t, e, n) {
		var i = new Xw({
	...
	function Cs(t, e, n) {
		return e && !g(e) && (e = cx.getLocalTransform(e)), n && (e = Ue([], e)), ye([], t, e);
	}
	function Is(t, e, n) {
		...
		if (t && e) {
			...
			e.traverse(function (t) {
				if (Ds(t) && t.anid) {
					...
					if (e) {
						var i = r(t);
						t.attr(r(e)), ls(t, i, n, ib(t).dataIndex);
					}
				}
			});
		}
	...
	function Os(t, e, n) {
		...
		return (
			...
			t
				? 0 === t.indexOf('image://')
					? ((r.image = t.slice(8)), c(r, n), new Xw(i))
	...
	function Gs(t, e, n) {
		...
		for (var l = { normal: i }, u = 0; u < pb.length; u++) {
			var h = pb[u],
				c = e[h];
	...
	function Ws(t, e, n, i) {
		n = n || PS;
		for (var r = t instanceof Jw, o = !1, a = 0; a < fb.length; a++) {
			var s = e[fb[a]];
		...
		if (o) {
			r ||
				(l || ((l = new Jw()), t.setTextContent(l)), t.stateProxy && (l.stateProxy = t.stateProxy));
			var u = Gs(n, e),
				h = e.normal,
				c = !!h.getShallow('show'),
	...
	function Us(t, e) {
		e = e || 'label';
		for (var n = { normal: t.getModel(e) }, i = 0; i < pb.length; i++) {
			var r = pb[i];
			n[r] = t.getModel([r, e]);
		}
		return n;
	...
	function nl(t, e) {
		(t = t.toUpperCase()), (tM[t] = new YS(e)), (JS[t] = e);
	}
	function il(t) {
		if (C(t)) {
			var e = JS[t.toUpperCase()] || {};
			return t === KS || t === $S ? s(e) : l(s(e), s(JS[QS]), !1);
		}
		return l(s(t), s(JS[QS]), !1);
	}
	function rl(t) {
		return tM[t];
	}
	...
	function hl(t, e, n, i) {
		var r = tr(t),
			...
			f = r[_l(n)](),
			d = r[xl(n)](),
			g = i instanceof YS ? i : rl(i || eM) || ol(),
			v = g.getModel('time'),
			y = v.get('month'),
			m = v.get('monthAbbr'),
			_ = v.get('dayOfWeek'),
	...
	function cl(t, e, n, i, r) {
		...
		if (C(n)) o = n;
			...
			var a = h({}, sM);
			if (t.level > 0) for (var s = 0; s < hM.length; ++s) a[hM[s]] = '{primary|' + a[hM[s]] + '}';
			var l = n ? (n.inherit === !1 ? n : c(n, a)) : a,
				u = pl(t.value, r);
			if (l[u]) o = l[u];
			else if (l.inherit) {
				for (var p = cM.indexOf(u), s = p - 1; s >= 0; --s)
					if (l[u]) {
						o = l[u];
						break;
					}
		...
		return hl(new Date(t.value), o, r, i);
	}
	function pl(t, e) {
		var n = tr(t),
			i = n[gl(e)]() + 1,
	...
	function Pl(t, e, n) {
		...
		if (a || s) {
			var l = a ? tr(t) : t;
			if (!isNaN(+l)) return hl(l, o, n);
			if (s) return '-';
		}
		if ('ordinal' === e) return I(t) ? i(t) : D(t) && r(t) ? t + '' : '-';
		var u = ar(t);
		return r(u) ? kl(u) : I(t) ? i(t) : 'boolean' == typeof t ? t + '' : '-';
	}
	function Ll(t, e, n) {
		M(e) || (e = [e]);
		var i = e.length;
		...
		for (var r = e[0].$vars || [], o = 0; o < r.length; o++) {
			var a = fM[o];
			t = t.replace(dM(a), dM(a, 0));
		}
		for (var s = 0; i > s; s++)
			for (var l = 0; l < r.length; l++) {
				var u = e[s][r[l]];
				t = t.replace(dM(fM[l], s), n ? Ie(u) : u);
			}
		return t;
	}
	function Ol(t, e) {
	...
	function Ul(t) {
		var e = [];
		return (
			v(xM.getClassesByMainType(t), function (t) {
	...
	function ql(t, e, n) {
		...
		var l = (function () {
			...
			for (var i = {}, r = {}, l = [], u = 0, h = Math.min(5, n); h > u; u++) {
				var c = $l(e.data, a, e.seriesLayoutBy, s, e.startIndex, u);
				l.push(c);
				var p = c === EM.Not;
				if (
					(p && null == i.v && u !== o && (i.v = u),
					(null == i.n || i.n === i.v || (!p && l[i.n] === EM.Not)) && (i.n = u),
					t(i) && l[i.n] !== EM.Not)
				)
					return i;
				p ||
					(c === EM.Might && null == r.v && u !== o && (r.v = u),
	...
	function Kl(t, e) {
		return $l(t.data, t.sourceFormat, t.seriesLayoutBy, t.dimensionsDefine, t.startIndex, e);
	}
	...
	function au(t) {
		...
		return (
			t &&
				v(fr(t.replaceMerge), function (t) {
					e.set(t, !0);
				}),
	...
	function du(t, e) {
		var n = nT(t) && t[e],
			i = nT(n) && n.textStyle;
		if (i)
			for (var r = 0, o = Ox.length; o > r; r++) {
				var a = Ox[r];
				i.hasOwnProperty(a) && (n[a] = i[a]);
			}
	}
	function gu(t) {
		t && (fu(t), du(t, 'label'), t.emphasis && du(t.emphasis, 'label'));
	}
	function vu(t) {
		if (nT(t)) {
			cu(t),
				...
				du(t, 'edgeLabel'),
				t.emphasis &&
					(du(t.emphasis, 'label'), du(t.emphasis, 'upperLabel'), du(t.emphasis, 'edgeLabel'));
			var e = t.markPoint;
			e && (cu(e), gu(e));
			var n = t.markLine;
			n && (cu(n), gu(n));
			...
			if (((n = t.markLine), n && n.data))
				for (var l = n.data, a = 0; a < l.length; a++)
					M(l[a]) ? (gu(l[a][0]), gu(l[a][1])) : gu(l[a]);
			'gauge' === t.type
				? (du(t, 'axisLabel'), du(t, 'title'), du(t, 'detail'))
				: 'treemap' === t.type
				? (pu(t.breadcrumb, 'itemStyle'),
	...
	function _u(t, e) {
		eT(yu(t.series), function (t) {
			nT(t) && vu(t);
		});
		var n = ['xAxis', 'yAxis', 'radiusAxis', 'angleAxis', 'singleAxis', 'parallelAxis', 'radar'];
		e && n.push('valueAxis', 'categoryAxis', 'logAxis', 'timeAxis'),
			eT(n, function (e) {
				eT(yu(t[e]), function (t) {
					t && (du(t, 'axisLabel'), du(t.axisPointer, 'label'));
				});
			}),
			eT(yu(t.parallel), function (t) {
				var e = t && t.parallelAxisDefault;
				du(e, 'axisLabel'), du(e && e.axisPointer, 'label');
			}),
			eT(yu(t.calendar), function (t) {
				pu(t, 'itemStyle'), du(t, 'dayLabel'), du(t, 'monthLabel'), du(t, 'yearLabel');
			}),
			eT(yu(t.radar), function (t) {
				du(t, 'name'),
			...
			eT(yu(t.geo), function (t) {
				nT(t) &&
					(gu(t),
					eT(yu(t.regions), function (t) {
						gu(t);
					}));
			}),
			eT(yu(t.timeline), function (t) {
			...
			eT(yu(t.toolbox), function (t) {
				pu(t, 'iconStyle'),
					eT(t.feature, function (t) {
						pu(t, 'iconStyle');
					});
			}),
			du(mu(t.axisPointer), 'label'),
			du(mu(t.tooltip).axisPointer, 'label');
	}
	function xu(t, e) {
					...
					if ('line' === e) null != t.clipOverflow && (t.clip = t.clipOverflow);
						...
						if (n && !P(n))
							for (var i = 0; i < n.length; i++)
								'object' == typeof n[i] && (Su(n[i]), Su(n[i] && n[i].emphasis));
					} else if ('sunburst' === e) {
	...
	function Lu(t, e, n) {
		...
		var i = e.seriesLayoutBy,
			r = zu(t, n, i, e.sourceHeader, e.dimensions),
			o = new sT({
				data: t,
				sourceFormat: n,
				seriesLayoutBy: i,
	...
	function Ou(t) {
		return new sT({ data: t, sourceFormat: P(t) ? PM : IM });
	}
	function Ru(t) {
		return new sT({
			data: t.data,
	...
	function zu(t, e, n, i, r) {
		var o, a;
		if (!t) return { dimensionsDefine: Nu(r), startIndex: a, dimensionsDetectedCount: o };
		if (e === DM) {
			var s = t;
			'auto' === i || null == i
				? Fu(
				...
				(o = r ? r.length : n === RM ? s.length : s[0] ? s[0].length : null);
		} else if (e === kM) r || (r = Bu(t));
		else if (e === AM)
			r ||
				((r = []),
				v(t, function (t, e) {
		...
		return { startIndex: a, dimensionsDefine: Nu(r), dimensionsDetectedCount: o };
	}
	function Bu(t) {
	...
	function Fu(t, e, n, i) {
		if (e === RM) for (var r = 0; r < n.length && i > r; r++) t(n[r] ? n[r][0] : null, r);
	...
	function Zu(t, e) {
		...
		e.__isBuiltIn &&
			...
			(n.getRawData = pm(Ku, null, t))),
			(n.cloneRawData = pm($u, null, t));
		var p = Gu(r, OM);
		n.count = pm(p, null, i, o, s);
		var f = Wu(r);
		...
		return (
			(n.getDimensionInfo = pm(Qu, null, s, l)), (n.cloneAllDimensionInfo = pm(Ju, null, s)), n
		);
	}
	function Ku(t) {
		var e = t.sourceFormat;
	...
	function th(t) {
		...
		2 !== i.length && cr(n);
		var r = !1;
		'echarts' === i[0] && ((e = i[1]), (r = !0)), (t.__isBuiltIn = r), bT.set(e, t);
	}
	function eh(t, e, n) {
		var i = fr(t),
			r = i.length,
	...
	function nh(t, e) {
		...
		var o = y(e, function (t) {
			...
			a = fr(r.transform({ upstream: o[0], upstreamList: o, config: s(t.config) }));
		return y(a, function (t, n) {
			...
			if (a && 0 === n && !t.dimensions) {
				...
				s && (t.data = a.data.slice(0, s).concat(t.data)),
					(o = { seriesLayoutBy: OM, sourceHeader: s, dimensions: a.metaRawOption.dimensions });
			} else o = { seriesLayoutBy: OM, sourceHeader: 0, dimensions: t.dimensions };
	...
	function vh(t, e, n, i) {
		...
		v(s, function (n, r) {
			var s = e.valueFormatter,
				l = dh(n)(s ? h(h({}, t), { valueFormatter: s }) : t, n, r > 0 ? o.html : 0, i);
			null != l && a.push(l);
		});
		var p = 'richText' === t.renderMode ? a.join(o.richText) : xh(a.join(''), r ? n : o.html);
		if (r) return p;
		var f = Pl(e.header, 'ordinal', t.useUTC),
			d = ch(i, t.renderMode).nameStyle;
		return 'richText' === t.renderMode
			? Sh(t, f, d) + o.richText + p
			: xh('<div style="' + d + ';' + PT + ';">' + Ie(f) + '</div>' + p, n);
	}
	function yh(t, e, n, i) {
		var r = t.renderMode,
			o = e.noName,
		...
		if (!o || !a) {
			var c = s
					? ''
					: t.markupStyleCreator.makeTooltipMarker(e.markerType, e.markerColor || '#333', r),
				p = o ? '' : Pl(l, 'ordinal', u),
				f = e.valueType,
				d = a ? [] : h(e.value),
				g = !s || !o,
				...
				x = m.valueStyle;
			return 'richText' === r
				? (s ? '' : c) + (o ? '' : Sh(t, p, _)) + (a ? '' : Mh(t, d, g, v, x))
				: xh((s ? '' : c) + (o ? '' : wh(p, !s, _)) + (a ? '' : bh(d, g, v, x)), n);
		}
	}
	...
	function _h(t) {
		return { html: LT[t], richText: OT[t] };
	}
	function xh(t, e) {
		var n = '<div style="clear:both"></div>',
			i = 'margin: ' + e + 'px 0 0';
		return '<div style="' + i + ';' + PT + ';">' + t + n + '</div>';
	}
	function wh(t, e, n) {
	...
	function Gh(t) {
		var e = t.model,
			...
			a = t.view,
			s = r && FT(r).updateMethod,
			l = o ? 'incrementalPrepareRender' : s && a[s] ? s : 'render';
		return 'render' !== l && a[l](e, n, i, r), WT[l];
	}
	function Wh(t, e, n) {
		function i() {
	...
	function Uh(t, e, n, i) {
		...
		if (r) {
			...
			if (s !== n || a !== i) {
				...
				(r = t[e] = Wh(o, n, 'debounce' === i)), (r[UT] = o), (r[YT] = i), (r[XT] = n);
			}
			return r;
		}
	}
	function Xh(t, e) {
		var n = t[e];
		n && n[UT] && (n.clear && n.clear(), (t[e] = n[UT]));
	}
	function Yh(t, e) {
		var n = t.visualStyleMapper || jT[e];
		return n ? n : (console.warn("Unknown style type '" + e + "'."), jT.itemStyle);
	}
	function qh(t, e) {
		var n = t.visualDrawType || ZT[e];
	...
	function jh(t, e) {
		...
		var n = new xx(),
			i = new Zw({ style: { fill: e.maskColor }, zlevel: e.zlevel, z: 1e4 });
		n.add(i);
		var r = new Jw({
				style: {
					text: e.text,
		...
		return (
			e.showSpinner &&
				((a = new cS({
					shape: { startAngle: -tC / 2, endAngle: -tC / 2 + 0.1, r: e.spinnerRadius },
				...
				a
					.animateShape(!0)
					.when(1e3, { endAngle: (3 * tC) / 2 })
					.start('circularInOut'),
				a
					.animateShape(!0)
					.when(1e3, { startAngle: (3 * tC) / 2 })
					.delay(300)
					.start('circularInOut'),
				n.add(a)),
			(n.resize = function () {
	...
	function uc(t, e, n) {
		t.on('selectchanged', function (t) {
			var i = n.getModel();
			t.isFromClick
				? (lc('map', 'selectchanged', e, i, t), lc('pie', 'selectchanged', e, i, t))
				: 'select' === t.fromAction
				? (lc('map', 'selected', e, i, t), lc('pie', 'selected', e, i, t))
				: 'unselect' === t.fromAction &&
				  (lc('map', 'unselected', e, i, t), lc('pie', 'unselected', e, i, t));
		});
	}
	function hc(t, e, n) {
	...
	function pc(t, e, n, i, r, o, a) {
		...
		return (
			(l =
				0 === t.indexOf('image://')
					? xs(t.slice(8), new jm(e, n, i, r), a ? 'center' : 'cover')
					: 0 === t.indexOf('path://')
					? _s(t.slice(7), {}, new jm(e, n, i, r), a ? 'center' : 'cover')
					: new IC({ shape: { symbolType: t, x: e, y: n, width: i, height: r } })),
			(l.__isEmptyBrush = s),
			(l.setColor = cc),
			o && l.setColor(o),
			l
	...
	function dc(t, e) {
		return null != t
			? (M(t) || (t = [t, t]), [Wi(t[0], e[0]) || 0, Wi(N(t[1], t[0]), e[1]) || 0])
			: void 0;
	}
	function gc(t) {
		return isFinite(t);
	...
	function mc(t, e, n) {
		for (
			var i = 'radial' === e.type ? yc(t, e, n) : vc(t, e, n), r = e.colorStops, o = 0;
			o < r.length;
			o++
		)
	...
	function wc(t, e, n) {
		...
		return ((t[r] || xc(s[i]) || xc(t.style[i])) - (xc(s[o]) || 0) - (xc(s[a]) || 0)) | 0;
	}
	function bc(t, e) {
	...
	function Sc(t) {
		var e = t.style,
			n = e.lineDash && e.lineWidth > 0 && bc(e.lineDash, e.lineWidth),
			i = e.lineDashOffset;
		if (n) {
		...
		if (to(i)) {
			...
			if ('function' == typeof DOMMatrix && r && r.setTransform) {
				...
				o.translateSelf(e.x || 0, e.y || 0),
					o.rotateSelf(0, 0, (e.rotation || 0) * ym),
	...
	function Ac(t, e, n, i) {
		...
		if (!i) {
			...
			(d || g) && (b = e.getBoundingRect()),
				d && ((m = c ? mc(t, p, b) : e.__canvasFillGradient), (e.__canvasFillGradient = m)),
				g && ((_ = c ? mc(t, f, b) : e.__canvasStrokeGradient), (e.__canvasStrokeGradient = _)),
				v &&
					((x = c || !e.__canvasFillPattern ? kc(t, p, e) : e.__canvasFillPattern),
					(e.__canvasFillPattern = x)),
				y &&
					((w = c || !e.__canvasStrokePattern ? kc(t, f, e) : e.__canvasStrokePattern),
		...
		var M, T;
		t.setLineDash && n.lineDash && ((r = Sc(e)), (M = r[0]), (T = r[1]));
		var C = !0;
		(u || c & a_) &&
			(h.setDPR(t.dpr),
			...
			i || (n.strokeFirst ? (o && Dc(t, n), a && Ic(t, n)) : (a && Ic(t, n), o && Dc(t, n))),
			M && t.setLineDash([]);
	}
	function Pc(t, e, n) {
	...
	function Lc(t, e, n) {
		var i,
			r = n.text;
		if ((null != r && (r += ''), r)) {
			(t.font = n.font || qy), (t.textAlign = n.textAlign), (t.textBaseline = n.textBaseline);
			var o = void 0,
				a = void 0;
			t.setLineDash && n.lineDash && ((i = Sc(e)), (o = i[0]), (a = i[1])),
				o && (t.setLineDash(o), (t.lineDashOffset = a)),
				n.strokeFirst
					? (Mc(n) && t.strokeText(r, n.x, n.y), Cc(n) && t.fillText(r, n.x, n.y))
					: (Cc(n) && t.fillText(r, n.x, n.y), Mc(n) && t.strokeText(r, n.x, n.y)),
				o && t.setLineDash([]);
		}
	}
	function Oc(t, e, n, i, r) {
		...
		if (i || e.opacity !== n.opacity) {
			...
			t.globalAlpha = isNaN(a) ? Kx.opacity : a;
		}
		(i || e.blend !== n.blend) &&
			(o || (Vc(t, r), (o = !0)), (t.globalCompositeOperation = e.blend || Kx.blend));
		for (var s = 0; s < kC.length; s++) {
			var l = kC[s];
			(i || e[l] !== n[l]) && (o || (Vc(t, r), (o = !0)), (t[l] = t.dpr * (e[l] || 0)));
		}
		return (
			(i || e.shadowColor !== n.shadowColor) &&
				(o || (Vc(t, r), (o = !0)), (t.shadowColor = e.shadowColor || Kx.shadowColor)),
			o
		);
	}
	function Rc(t, e, n, i, r) {
		...
		if (
			((i || o.fill !== a.fill) &&
				(s || (Vc(t, r), (s = !0)), Tc(o.fill) && (t.fillStyle = o.fill)),
			(i || o.stroke !== a.stroke) &&
				(s || (Vc(t, r), (s = !0)), Tc(o.stroke) && (t.strokeStyle = o.stroke)),
			(i || o.opacity !== a.opacity) &&
				(s || (Vc(t, r), (s = !0)), (t.globalAlpha = null == o.opacity ? 1 : o.opacity)),
			e.hasStroke())
		) {
			var l = o.lineWidth,
				u = l / (o.strokeNoScale && e.getLineScale ? e.getLineScale() : 1);
			t.lineWidth !== u && (s || (Vc(t, r), (s = !0)), (t.lineWidth = u));
		}
		for (var h = 0; h < AC.length; h++) {
			var c = AC[h],
				p = c[0];
			(i || o[p] !== a[p]) && (s || (Vc(t, r), (s = !0)), (t[p] = o[p] || c[1]));
		}
		return s;
	}
	function Ec(t, e, n, i, r) {
		return Oc(t, Hc(e, r.inHover), n && Hc(n, r.inHover), i, r);
	}
	function zc(t, e) {
		var n = e.transform,
			i = t.dpr || 1;
	...
	function Bc(t, e, n) {
		for (var i = !1, r = 0; r < t.length; r++) {
			var o = t[r];
			(i = i || o.isZeroArea()), zc(e, o), e.beginPath(), o.buildPath(e, o.shape), e.clip();
		}
		n.allClipped = i;
	}
	function Nc(t, e) {
	...
	function Wc(t, e, n, i) {
		...
		if (!e.shouldBePainted(n.viewWidth, n.viewHeight, !1, !1))
			return (e.__dirty &= ~r_), void (e.__isRendered = !1);
		var o = e.__clipPaths,
			a = n.prevElClipPaths,
			s = !1,
			l = !1;
		if (
			((!a || _c(o, a)) &&
				(a &&
					...
					(n.allClipped = !1),
					(n.prevEl = null)),
				o && o.length && (Vc(t, n), t.save(), Bc(o, t, n), (s = !0)),
				(n.prevElClipPaths = o)),
			n.allClipped)
		)
		...
		var u = n.prevEl;
		u || (l = s = !0);
		var h = e instanceof Vw && e.autoBatch && Fc(e.style);
		s || Nc(r, u.transform) ? (Vc(t, n), zc(t, e)) : h || Vc(t, n);
		var c = Hc(e, n.inHover);
		e instanceof Vw
			? (n.lastDrawType !== PC && ((l = !0), (n.lastDrawType = PC)),
			  Rc(t, e, u, l, n),
			  (h && (n.batchFill || n.batchStroke)) || t.beginPath(),
			  Ac(t, e, c, h),
			  h && ((n.batchFill = c.fill || ''), (n.batchStroke = c.stroke || '')))
			: e instanceof Gw
			? (n.lastDrawType !== OC && ((l = !0), (n.lastDrawType = OC)), Rc(t, e, u, l, n), Lc(t, e, c))
			: e instanceof Xw
			? (n.lastDrawType !== LC && ((l = !0), (n.lastDrawType = LC)), Ec(t, e, u, l, n), Pc(t, e, c))
			: e.getTemporalDisplayables &&
			  (n.lastDrawType !== RC && ((l = !0), (n.lastDrawType = RC)), Uc(t, e, n)),
			h && i && Vc(t, n),
			e.innerAfterBrush(),
	...
	function tp(t) {
		return function () {
			...
			return this.isDisposed() ? void 0 : np(this, t, e);
		};
	}
	function ep(t) {
		return function () {
	...
	function np(t, e, n) {
		return (n[0] = n[0] && n[0].toLowerCase()), Cm.prototype[e].apply(t, n);
	}
	function ip(t, e, n) {
		var i = !(n && n.ssr);
		if (i) {
	...
	function ap(t) {
		C(t) ? (t = WI[t]) : t instanceof OI || (t = sp(t)),
			t instanceof OI && !t.isDisposed() && t.dispose();
	}
	function sp(t) {
		return WI[Br(t, qI)];
	}
	...
	function gp(t, e, n) {
		...
		(t.event = (t.event || i).toLowerCase()),
			(e = t.event),
			BI[e] ||
				(G(lI.test(i) && lI.test(e)), zI[i] || (zI[i] = { action: n, actionInfo: t }), (BI[e] = i));
	}
	function vp(t, e) {
		QM.register(t, e);
	}
	...
	function xp(t, e, n, i, r) {
		if (((T(e) || k(e)) && ((n = e), (e = i)), !(p(ZI, n) >= 0))) {
			ZI.push(n);
			var o = eC.wrapStageHandler(n, r);
	...
	function Ip(t, e) {
		...
		v(t.dimensions, function (e) {
			...
			if (l) {
				...
				(Dp(i, l)[u] = e),
					n.isExtraCoord ||
						(r.set(l, 1), Ap(n.type) && (o[0] = e), (Dp(s, l)[u] = t.getDimensionIndex(n.name))),
					n.defaultTooltip && a.push(e);
			}
			CM.each(function (t, e) {
				var r = Dp(i, e),
					o = n.otherDims[e];
	...
	function Op(t) {
		var e = lD(t);
		return e.dimNameMap || (e.dimNameMap = Lp(t.dimensionsDefine));
	}
	function Rp(t) {
		return t > 30;
	}
	function Ep(t, e) {
		return zp(t, e).dimensions;
	}
	function zp(t, e) {
		function n(t) {
			var e = m[t];
		...
		var o = e.coordDimensions || [],
			...
			p = e.canOmitUnusedDimensions && Rp(u),
			f = a === t.dimensionsDefine,
			d = f ? Op(t) : Lp(a),
			g = e.encodeDefine;
		!g && e.encodeDefaulter && (g = e.encodeDefaulter(t, u));
		for (var y = q(g), m = new CT(u), _ = 0; _ < m.length; _++) m[_] = -1;
			...
			for (var T = 0; u > T; T++) {
				...
				null == D &&
					...
					null != I.type ||
						(Kl(t, T) !== EM.Must &&
							(!I.isExtraCoord ||
								(null == I.otherDims.itemName && null == I.otherDims.seriesName))) ||
						(I.type = 'ordinal');
			}
		return Bp(l), new hD({ source: t, dimensions: l, fullDimensionCount: u, dimensionOmitted: p });
	}
	function Bp(t) {
		for (var e = q(), n = 0; n < t.length; n++) {
			var i = t[n],
	...
	function Gp(t, e, n) {
		...
		Wp(e) ? (i = e) : ((r = e.schema), (i = r.dimensions), (o = e.store));
		var l,
			u,
			h,
			c,
	...
	function Xp(t, e) {
		return Up(t, e) ? t.getCalculationInfo('stackResultDimension') : e;
	}
	function Yp(t, e) {
		var n,
	...
	function jp(t, e, n) {
		...
		var i,
			...
			o = !1;
		t ? ((o = !0), (i = Ou(t))) : ((i = r.getSource()), (o = i.sourceFormat === IM));
		var a = Vp(e),
			s = Yp(e, a),
			l = n.useEncodeDefaulter,
			u = T(l) ? l : l ? S(Yl, s, e) : null,
			h = {
				coordDimensions: s,
			...
			c = zp(i, h),
			p = qp(c.dimensions, n.createInvertedIndices, a),
			f = o ? null : r.getSharedDataStore(c),
			d = Gp(e, { schema: c, store: f }),
			g = new mD(c, e);
	...
	function Jp(t, e, n, i) {
		...
		var s = (r.intervalPrecision = ef(a)),
	...
	function lf(t) {
		return M(t) ? (ID ? new Float32Array(t) : t) : new DD(t);
	}
	function uf(t) {
	...
	function ff(t) {
		...
		return (
			v(t, function (t) {
				...
				var f = Wi(t.get('barWidth'), i),
					d = Wi(t.get('barMaxWidth'), i),
					g = Wi(t.get('barMinWidth') || (yf(t) ? 0.5 : 1), i),
					v = t.get('barGap'),
	...
	function _f(t) {
		return (t /= oM), t > 16 ? 16 : t > 7.5 ? 7 : t > 3.5 ? 4 : t > 1.5 ? 2 : 1;
	}
	function xf(t) {
		var e = 30 * oM;
	...
	function wf(t) {
		return (t /= rM), t > 12 ? 12 : t > 6 ? 6 : t > 3.5 ? 4 : t > 2 ? 2 : 1;
	}
	function bf(t, e) {
		return (
			(t /= e ? iM : nM),
	...
	function Tf(t, e, n, i) {
		...
		function o(t, o, a) {
			var s = [],
				l = !o.length;
			if (!mf(sl(t), i[0], i[1], n)) {
				l && (o = [{ value: Mf(new Date(i[0]), t, n) }, { value: i[1] }]);
				for (var u = 0; u < o.length - 1; u++) {
					...
					if (h !== c) {
						...
						switch (t) {
							case 'year':
								(p = Math.max(1, Math.round(e / oM / 365))), (f = dl(n)), (d = wl(n));
								break;
							case 'half-year':
							case 'quarter':
							case 'month':
								(p = xf(e)), (f = gl(n)), (d = bl(n));
								break;
							case 'week':
							case 'half-week':
							case 'day':
								(p = _f(e, 31)), (f = vl(n)), (d = Sl(n)), (g = !0);
								break;
							case 'half-day':
							case 'quarter-day':
							case 'hour':
								(p = wf(e)), (f = yl(n)), (d = Ml(n));
								break;
							case 'minute':
								(p = bf(e, !0)), (f = ml(n)), (d = Tl(n));
								break;
							case 'second':
								(p = bf(e, !1)), (f = _l(n)), (d = Cl(n));
								break;
							case 'millisecond':
								(p = Sf(e)), (f = xl(n)), (d = Il(n));
						}
						r(p, h, c, f, d, g, s),
		...
		for (
			var a = 1e4, s = cM, l = 0, u = [], h = [], c = 0, p = 0, f = 0;
			f < s.length && l++ < a;
			++f
		) {
			var d = sl(s[f]);
	...
	function If(t, e, n) {
		...
		return i ? i : ((i = new GD(t, e, n)), (t.rawExtentInfo = i), i);
	}
	function Df(t, e) {
	...
	function kf(t, e) {
		var n = t.type,
			i = If(t, e, t.getExtent()).calculate();
	...
	function Pf(t, e) {
		var n = e,
			...
			r = i.extent,
			o = n.get('splitNumber');
		t instanceof VD && (t.base = n.get('logBase'));
		var a = t.type,
			s = n.get('interval'),
			l = 'interval' === a || 'time' === a;
		t.setExtent(r[0], r[1]),
	...
	function Lf(t, e) {
		if ((e = e || t.get('type')))
			switch (e) {
				...
				case 'time':
					return new PD({ locale: t.ecModel.getLocaleModel(), useUTC: t.ecModel.get('useUTC') });
				default:
					return new (wD.getClass(e) || CD)();
			}
	}
	function Of(t) {
		...
		return 'time' === t.scale.type
			...
			? (function (e) {
					return function (i, r) {
						return (
							null != n && (r = i.value - n),
							e(Ef(t, i), r, null != i.level ? { level: i.level } : null)
						);
					};
			  })(e)
			: function (e) {
	...
	function zf(t) {
		...
		if (e.get(['axisLabel', 'show']) && !n.isBlank()) {
			var i,
				r,
				o = n.getExtent();
			n instanceof MD ? (r = n.count()) : ((i = n.getTicks()), (r = i.length));
			var a,
				s = t.getLabelModel(),
				l = Rf(t),
				u = 1;
	...
	function Ff(t) {
		return 'category' === t.type && 0 === Nf(t.getLabelModel());
	}
	function Vf(t, e) {
		var n = {};
		return (
	...
	function Gf(t, e) {
		var n = e;
		e instanceof YS || (n = new YS(e));
		var i = Lf(n);
		return i.setExtent(t[0], t[1]), Pf(i, n), i;
	}
	function Wf(t) {
		d(t, XD);
	}
	...
	function Xf(t) {
		return M(t)
			...
			: void (p(jD, t) >= 0 || (jD.push(t), T(t) && (t = { install: t }), t.install(ZD)));
	}
	function Yf(t, e) {
		return Math.abs(t - e) < KD;
	}
	function qf(t, e, n) {
		var i = 0,
			r = t[0];
		...
		var s = t[0];
		return (Yf(r[0], s[0]) && Yf(r[1], s[1])) || (i += Mo(r[0], r[1], s[0], s[1], e, n)), 0 !== i;
	}
	function jf(t, e) {
	...
	function Qf(t, e, n) {
		for (var i = 0; i < t.length; i++) t[i] = Jf(t[i], e[i], n);
	}
	function Jf(t, e, n) {
				...
				function (t) {
					...
					switch (i.type) {
						...
						case 'MultiPolygon':
							...
							break;
						case 'LineString':
							r.push(new tk([i.coordinates]));
							break;
						case 'MultiLineString':
							r.push(new tk(i.coordinates));
					}
					var a = new ek(n[e || 'name'], r, n.cp);
	...
	function ed(t) {
		return 'category' === t.type ? id(t) : ad(t);
	}
	function nd(t, e) {
	...
	function rd(t, e) {
		...
		var o, a;
		return (
			T(i) ? (o = dd(t, i)) : ((a = 'auto' === i ? hd(t) : i), (o = fd(t, a))),
			ud(n, i, { labels: o, labelCategoryInterval: a })
		);
	}
	function od(t, e) {
		var n = sd(t, 'ticks'),
		...
		if (r) return r;
		var o, a;
		if (((!e.get('show') || t.scale.isBlank()) && (o = []), T(i))) o = dd(t, i, !0);
		else if ('auto' === i) {
			var s = rd(t, t.getLabelModel());
			(a = s.labelCategoryInterval),
				(o = y(s.labels, function (t) {
					return t.tickValue;
				}));
		} else (a = i), (o = fd(t, a, !0));
		return ud(n, i, { ticks: o, tickCategoryInterval: a });
	}
	function ad(t) {
	...
	function hd(t) {
		var e = sk(t).autoInterval;
		return null != e ? e : (sk(t).autoInterval = t.calculateCategoryInterval());
	}
	function cd(t) {
		var e = pd(t),
			n = Rf(t),
		...
		for (
			...
			var d = 0,
				g = 0,
				v = wi(n({ value: l }), e.font, 'center', 'top');
	...
	function yd(t) {
		var e = xM.extend(t);
		return xM.registerClass(e), e;
	}
	function md(t) {
		var e = NT.extend(t);
		return NT.registerClass(e), e;
	}
	function _d(t) {
		var e = BT.extend(t);
		return BT.registerClass(e), e;
	}
	function xd(t) {
		var e = HT.extend(t);
	...
	function bd(t, e, n, i, r, o, a, s, l) {
		...
		var h = a * n + t,
			c = s * n + e;
		if (Math.abs(i - r) % hk < 1e-4) return (l[0] = h), (l[1] = c), u - n;
		if (o) {
			var p = i;
			(i = bo(r)), (r = bo(p));
		} else (i = bo(i)), (r = bo(r));
		...
		if ((0 > f && (f += hk), (f >= i && r >= f) || (f + hk >= i && r >= f + hk)))
	...
	function Td(t, e, n) {
		var i = Md(e.x, e.y, e.width, e.height, t.x, t.y, fk);
		return n.set(fk[0], fk[1]), i;
	}
	function Cd(t, e, n) {
		for (
			...
			switch (d) {
				case ck.M:
					...
					break;
				case ck.L:
					(g = Sd(o, a, h[f], h[f + 1], c, p, fk, !0)), (o = h[f++]), (a = h[f++]);
					break;
				case ck.C:
					(g = gn(o, a, h[f++], h[f++], h[f++], h[f++], h[f], h[f + 1], c, p, fk)),
						(o = h[f++]),
						(a = h[f++]);
					break;
				case ck.Q:
					(g = bn(o, a, h[f++], h[f++], h[f], h[f + 1], c, p, fk)), (o = h[f++]), (a = h[f++]);
					break;
				case ck.A:
					var v = h[f++],
						y = h[f++],
				...
				case ck.R:
					...
					break;
				case ck.Z:
					(g = Sd(o, a, s, l, c, p, fk, !0)), (o = s), (a = l);
			}
			u > g && ((u = g), n.set(fk[0], fk[1]));
		}
		return u;
	}
	function Id(t, e) {
		if (t) {
			...
			if (i && n) {
				...
				for (var f = 0; f < a.length; f++) {
					var d = a[f];
					wd(d, 0, s, dk, yk), Fm.scaleAndAdd(gk, dk, yk, p), gk.transform(c);
					var g = t.getBoundingRect(),
						v = u ? u.distance(gk) : t instanceof Vw ? Cd(gk, t.path, vk) : Td(gk, g, vk);
					l > v &&
						((l = v),
						gk.transform(h),
						vk.transform(h),
				...
				Dd(o, e.get('minTurnAngle')), n.setShape({ points: o });
			}
		}
	}
	function Dd(t, e) {
		if (180 >= e && e > 0) {
			...
			var n = yk.len(),
				i = mk.len();
			if (!(0.001 > n || 0.001 > i)) {
				yk.scale(1 / n), mk.scale(1 / i);
				var r = yk.dot(mk),
					o = Math.cos(e);
				if (r > o) {
					var a = Sd(gk.x, gk.y, vk.x, vk.y, dk.x, dk.y, _k, !1);
					xk.fromArray(_k), xk.scaleAndAdd(mk, a / Math.tan(Math.PI - e));
					var s = vk.x !== gk.x ? (xk.x - gk.x) / (vk.x - gk.x) : (xk.y - gk.y) / (vk.y - gk.y);
					if (isNaN(s)) return;
					0 > s ? Fm.copy(xk, gk) : s > 1 && Fm.copy(xk, vk), xk.toArray(t[1]);
				}
			}
		}
	}
	function kd(t, e, n) {
		if (180 >= n && n > 0) {
			...
			var i = yk.len(),
				r = mk.len();
			if (!(0.001 > i || 0.001 > r)) {
				yk.scale(1 / i), mk.scale(1 / r);
				var o = yk.dot(e),
					a = Math.cos(n);
				if (a > o) {
					var s = Sd(gk.x, gk.y, vk.x, vk.y, dk.x, dk.y, _k, !1);
					xk.fromArray(_k);
					var l = Math.PI / 2,
						u = Math.acos(mk.dot(e)),
						h = l + u - n;
					if (h >= l) Fm.copy(xk, vk);
					else {
						xk.scaleAndAdd(mk, s / Math.tan(Math.PI / 2 - h));
						var c = vk.x !== gk.x ? (xk.x - gk.x) / (vk.x - gk.x) : (xk.y - gk.y) / (vk.y - gk.y);
						if (isNaN(c)) return;
						0 > c ? Fm.copy(xk, gk) : c > 1 && Fm.copy(xk, vk);
					}
					xk.toArray(t[1]);
				}
			}
	...
	function Ld(t, e, n) {
		...
		for (var o = e.normal, a = o.get('show'), s = r.ignore, l = 0; l < fb.length; l++) {
			var u = fb[l],
				h = e[u],
				p = 'normal' === u;
			if (h) {
		...
		if (i) {
			...
			(y.showAbove = v || !1), (i.buildPath = Pd);
		}
	}
	function Od(t, e) {
		e = e || 'labelLine';
	...
	function zd(t, e, n, i) {
		return Ed(t, 'x', 'width', e, n, i);
	}
	function Bd(t, e, n, i) {
		return Ed(t, 'y', 'height', e, n, i);
	}
	function Nd(t) {
		function e(t) {
			if (!t.ignore) {
		...
		for (var i = new jm(0, 0, 0, 0), r = 0; r < t.length; r++) {
			var o = t[r],
				a = o.axisAligned,
				s = o.localRect,
				l = o.transform,
			...
			for (var c = o.obb, p = !1, f = 0; f < n.length; f++) {
				...
				if (i.intersect(d.rect)) {
					...
					if (
						(d.obb || (d.obb = new xS(d.localRect, d.transform)),
						c || (c = new xS(s, l)),
						c.intersect(d.obb))
					) {
						p = !0;
	...
	function Vd(t, e) {
		...
		return {
			...
			labelLinePoints: Fd(i && i.shape.points)
		};
	}
	function Hd(t, e, n) {
		for (var i = 0; i < n.length; i++) {
	...
	function Gd(t) {
		t.registerUpdateLifecycle('series:beforeupdate', function (t, e) {
			var n = Ik(e).labelManager;
			n || (n = Ik(e).labelManager = new Ck()), n.clearLabels();
		}),
			t.registerUpdateLifecycle('series:layoutlabels', function (t, e, n) {
				var i = Ik(e).labelManager;
	...
	function Yd(t) {
		t.registerPainter('canvas', Ok);
	}
	function qd(t) {
		t.registerComponentModel(Rk), t.registerComponentView(Ek);
	}
	function jd(t, e) {
	...
	function rg(t, e, n, i, r, o, a) {
		...
		for (
			var P = l.length, L = lf(P), O = lf(P), R = lf(P), E = lf(P), z = [], m = 0;
			m < f.length;
			m++
		) {
			var B = f[m],
				...
				if (a > 0) {
					for (var w = g + o, b = e[2 * w], S = e[2 * w + 1]; b === y && S === m && i > v; )
						v++,
							...
							(x = m - h);
					var M = v + 1;
					if (l) for (; og(b, S) && i > M; ) M++, (w += o), (b = e[2 * w]), (S = e[2 * w + 1]);
					var T = 0.5,
						C = 0,
						I = 0,
						D = void 0,
						k = void 0;
					if (M >= i || og(b, S)) (f = y), (d = m);
					else {
						(C = b - u), (I = S - h);
						var A = y - u,
							P = b - y,
						...
						if ('x' === s) {
							...
							var z = C > 0 ? 1 : -1;
							(f = y - z * R * a), (d = m), (D = y + z * E * a), (k = m);
						} else if ('y' === s) {
							(R = Math.abs(L)), (E = Math.abs(O));
							var B = I > 0 ? 1 : -1;
							(f = y), (d = m - B * R * a), (D = y), (k = m + B * E * a);
						} else
							(R = Math.sqrt(A * A + L * L)),
								(E = Math.sqrt(P * P + O * O)),
								(T = E / (E + R)),
	...
	function sg(t, e, n, i, r) {
		...
		var c = new Zw({ shape: { x: a, y: s, width: l, height: u } });
		if (e) {
			var p = t.getBaseAxis(),
				f = p.isHorizontal(),
				d = p.inverse;
	...
	function lg(t, e, n) {
		...
		if (e) {
			...
			s ? (a.shape.endAngle = i.startAngle) : (a.shape.r = r),
				us(a, { shape: { endAngle: i.endAngle, r: o } }, n);
		}
		return a;
	}
	function ug(t, e) {
	...
	function dg(t, e, n) {
		...
		for (var i = e.count(), r = lf(2 * i), o = 0; i > o; o++) {
			var a = ng(n, t, e, o);
	...
	function yg(t, e, n) {
		...
		if (i && i.length && t.count() && 'cartesian2d' === e.type) {
			...
			if (o) {
				...
				var p = vg(u, 'x' === r ? n.getWidth() : n.getHeight()),
					f = p.length;
				if (!f && h)
				...
				v(p, function (t) {
					...
					p.push({ offset: f ? p[f - 1].offset : 0.5, color: c[1] || 'transparent' }),
					p.unshift({ offset: f ? p[0].offset : 0.5, color: c[0] || 'transparent' });
	...
	function _g(t, e) {
		...
		for (var r = e.count(), o = Math.max(1, Math.round(r / 5)), a = 0; r > a; a += o)
			if (1.5 * Bk.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > i) return !1;
		return !0;
	}
	function xg(t, e) {
		return isNaN(t) || isNaN(e);
					...
					return (
						s && {
							progress: function (t, e) {
								for (
									var n = t.end - t.start, r = o && lf(n * s), a = [], l = [], p = t.start, f = 0;
									p < t.end;
									p++
								) {
									var d = void 0;
									if (1 === s) {
										...
										(a[0] = u.get(h, p)), (a[1] = u.get(c, p)), (d = i.dataToPoint(a, null, l));
			...
			reset: function (t, e, n) {
				...
				if (a > 10 && 'cartesian2d' === o.type && r) {
					...
					if (isFinite(p) && p > 1) {
						...
						var f = void 0;
						C(r) ? (f = Yk[r]) : T(r) && (f = r),
							f && t.setData(i.downSample(i.mapDimension(l.dim), 1 / p, f, qk));
					}
				}
			}
		};
	...
	function kg(t) {
		t.registerChartView(Xk),
			...
			t.registerProcessor(t.PRIORITY.PROCESSOR.STATISTIC, Dg('line'));
	}
	function Ag(t, e) {
	...
	function Rg(t, e, n, i, r, o, a, s, l, u) {
		function h(t) {
	...
	function Eg(t, e, n, i, r, o, a, s) {
		for (
			...
			var f = t[p].label;
			Bg(t[p]) ||
				(f.x < e ? ((h = Math.min(h, f.x)), l.push(t[p])) : ((c = Math.max(c, f.x)), u.push(t[p])));
		}
		for (var p = 0; p < t.length; p++) {
			var d = t[p];
			if (!Bg(d) && d.linePoints) {
		...
		Rg(u, e, n, i, 1, r, o, a, s, c), Rg(l, e, n, i, -1, r, o, a, s, h);
		for (var p = 0; p < t.length; p++) {
			var d = t[p];
			if (!Bg(d) && d.linePoints) {
				var f = d.label,
				...
				y
					...
					: ((g[2][0] = f.x < e ? f.x + d.labelDistance : f.x - d.labelDistance),
					  (g[1][0] = g[2][0] + b)),
					(g[1][1] = g[2][1] = f.y);
			}
		}
	...
	function Ng(t) {
		...
		var i,
			...
			a = [],
			s = !1,
			l = (t.get('minShowLabelAngle') || 0) * Kk,
		...
		o.each(function (t) {
			var u = o.getItemGraphicEl(t),
				...
				w = m.get('alignTo'),
				b = Wi(m.get('edgeDistance'), c),
				S = m.get('bleedMargin'),
				M = y.getModel('labelLine'),
				T = M.get('length');
			T = Wi(T, c);
			var C = M.get('length2');
			if (((C = Wi(C, c)), Math.abs(f.endAngle - f.startAngle) < l))
				return v(d.states, e), (d.ignore = !0), void (g && (v(g.states, e), (g.ignore = !0)));
			if (n(d)) {
				var I,
					k,
					A,
				...
				if ('center' === _) (I = f.cx), (k = f.cy), (P = 'center');
					...
					var z = (E ? ((f.r + f.r0) / 2) * O : f.r * O) + i,
						B = (E ? ((f.r + f.r0) / 2) * R : f.r * R) + r;
					...
					P = E ? 'center' : 'edge' === w ? (O > 0 ? 'right' : 'left') : O > 0 ? 'left' : 'right';
				}
				var G = Math.PI,
					W = 0,
					U = m.get('rotate');
			...
			!s && t.get('avoidLabelOverlap') && Eg(a, i, r, h, c, d, p, f);
		for (var g = 0; g < a.length; g++) {
			...
			if (_) {
				...
				x || !b
					...
					: (Dd(b, y.minTurnAngle),
					  kd(b, y.surfaceNormal, y.maxSurfaceAngle),
					  _.setShape({ points: b }),
					  (m.__hostTarget.textGuideLineConfig = { anchor: new Fm(b[0][0], b[0][1]) }));
			}
		}
	}
	function Fg(t, e, n) {
	...
	function Gg(t) {
		t.registerChartView(Qk),
			t.registerSeriesModel(eA),
			sc('pie', t.registerAction),
			t.registerLayout(S(Lg, 'pie')),
			t.registerProcessor(Og('pie')),
			t.registerProcessor(Hg('pie'));
	}
	function Wg(t, n, i, r) {
		v(hA, function (o, a) {
			var s = l(l({}, uA[a], !0), r, !0),
				u = (function (t) {
					function i() {
					...
					return (
						...
						(i.prototype.optionUpdated = function () {
							var t = this.option;
							'category' === t.type && (this.__ordinalMeta = SD.createByAxisModel(this));
						}),
		...
		return (
			v(e, function (n, i) {
				var r = i.replace(/Model$/, ''),
					o = t.getReferringComponents(r, Ex).models[0];
				e[i] = o;
			}),
			e
		);
	...
	function $g(t, e, n, i) {
		...
		if (l) {
			if (null != u) Qg(a[u]) && (o = a[u]);
			else
				for (var h in a)
					if (a.hasOwnProperty(h) && Qg(a[h]) && !i[r(a[h])]) {
						o = a[h];
						break;
					}
			o && (i[r(o)] = !0);
	...
	function tv(t, e, n, i) {
		...
		return (
			Ji(a - yA / 2)
				...
				: ((o = 'middle'),
				  (r = 1.5 * yA > a && a > yA / 2 ? (l ? 'left' : 'right') : l ? 'right' : 'left')),
	...
	function ev(t, e, n) {
		if (!Ff(t.axis)) {
			...
			var o = e[0],
				...
				c = n[n.length - 1],
				p = n[n.length - 2];
			i === !1 ? (nv(o), nv(u)) : iv(o, a) && (i ? (nv(a), nv(h)) : (nv(o), nv(u))),
				r === !1 ? (nv(s), nv(c)) : iv(l, s) && (r ? (nv(l), nv(p)) : (nv(s), nv(c)));
		}
	}
	function nv(t) {
		t && (t.ignore = !0);
		...
		if (o.get('show') && !r.scale.isBlank()) {
			...
			if (a.length)
				for (
					...
					for (var p = ov(a[h], e.transform, l, u, 'minorticks_' + h), f = 0; f < p.length; f++)
						t.add(p[f]);
		}
	}
	function lv(t, e, n, i) {
		...
		if (o && !r.scale.isBlank()) {
			var a = n.getModel('axisLabel'),
				s = a.get('margin'),
				l = r.getViewLabels(),
				u = ((B(i.labelRotate, a.get('rotate')) || 0) * yA) / 180,
				h = mA.innerTextLayout(i.rotation, u, i.labelDirection),
				c = n.getCategories && n.getCategories(!0),
				p = [],
				f = mA.isLabelSilent(n),
			...
			return (
				v(l, function (o, l) {
					...
					if (c && c[u]) {
						var m = c[u];
						k(m) && m.textStyle && (y = new YS(m.textStyle, a, n.ecModel));
					}
					...
					if (((w.anid = 'label_' + u), d)) {
						var b = mA.makeAxisEventDataBase(n);
	...
	function uv(t, e) {
		...
		return hv(n, t, e), n.seriesInvolved && pv(n, t), n;
	}
	function hv(t, e, n) {
		...
		v(n.getCoordinateSystems(), function (n) {
			function s(i, s, l) {
				var h = l.model.getModel('axisPointer', r),
					p = h.get('show');
				if (p && ('auto' !== p || i || mv(h))) {
					null == s && (s = h.get('triggerTooltip')), (h = i ? cv(l, c, r, e, i, s) : h);
					var f = h.get('snap'),
						d = _v(l.model),
	...
	function cv(t, e, n, i, r, o) {
		...
		return t.model.getModel('axisPointer', new YS(u, n, i));
	}
	function pv(t, e) {
		e.eachSeries(function (e) {
			...
			n &&
				...
				v(t.coordSysAxesInfo[_v(n.model)], function (t) {
					var i = t.axis;
					n.getAxis(i.dim) === i &&
	...
	function fv(t, e) {
		for (var n = e.model, i = e.dim, r = 0; r < t.length; r++) {
			...
			if (
				dv(o[i + 'AxisId'], n.id) ||
				dv(o[i + 'AxisIndex'], n.componentIndex) ||
				dv(o[i + 'AxisName'], n.name)
			)
				return r;
		}
	}
	...
	function xv(t, e, n, i) {
		...
		if (!r.scale.isBlank()) {
			...
			if (u.length) {
				...
				bA(t).splitAreaColors = f;
			}
		}
	}
	function wv(t) {
		bA(t).splitAreaColors = null;
	}
	function bv(t) {
		t.registerComponentView(kA),
			t.registerComponentModel(nA),
			t.registerCoordinateSystem('cartesian2d', vA),
			Wg(t, 'x', iA, AA),
			Wg(t, 'y', iA, AA),
			t.registerComponentView(IA),
			t.registerComponentView(DA),
			t.registerPreprocessor(function (t) {
				t.xAxis && t.yAxis && !t.grid && (t.grid = {});
			});
	}
	function Sv(t) {
		t.registerComponentModel(PA), t.registerComponentView(LA);
	}
	function Mv(t, e) {
		var n = pM(e.get('padding')),
	...
	function Tv(t, e, n, i, r, o, a) {
		...
		(u.decal = c && 'inherit' !== c ? Xc(c, a) : i.decal),
		...
		if (
			...
			var d = e.get('inactiveBorderWidth'),
				g = u[h];
			(u.lineWidth = 'auto' === d ? (i.lineWidth > 0 && g ? 2 : 0) : u.lineWidth),
	...
	function Cv(t) {
		...
		return (
			...
			e.indexOf('empty') > -1 &&
				((n.style.stroke = n.style.fill), (n.style.fill = '#fff'), (n.style.lineWidth = 2)),
			n
		);
	}
	function Iv(t, e, n, i) {
	...
	function Ov(t) {
		t.registerAction('legendToggleSelect', 'legendselectchanged', S(Lv, 'toggleSelected')),
			t.registerAction('legendAllSelect', 'legendselectall', S(Lv, 'allSelect')),
			t.registerAction('legendInverseSelect', 'legendinverseselect', S(Lv, 'inverseSelect')),
			t.registerAction('legendSelect', 'legendselected', S(Lv, 'select')),
			t.registerAction('legendUnSelect', 'legendunselected', S(Lv, 'unSelect'));
	}
	function Rv(t) {
		t.registerComponentModel(RA),
			t.registerComponentView(NA),
			t.registerProcessor(t.PRIORITY.PROCESSOR.SERIES_FILTER, Pv),
	...
	function Ev(t, e, n) {
		var i = t.getOrient(),
			r = [1, 1];
		(r[i.index] = 0), Hl(e, n, { type: 'box', ignoreSize: !!r });
	}
	function zv(t) {
	...
	function Bv(t) {
		Xf(Rv), t.registerComponentModel(FA), t.registerComponentView(WA), zv(t);
	}
	function Nv(t, e, n, i) {
		Fv(UA(n).lastProp, i) ||
			((UA(n).lastProp = i), e ? ls(n, i, t) : (n.stopAnimation(), n.attr(i)));
	}
	function Fv(t, e) {
		if (k(t) && k(e)) {
			var n = !0;
	...
	function Uv(t, e, n, i, r) {
		...
		'bottom' === g && (c[1] -= f), 'middle' === g && (c[1] -= f / 2), Xv(c, p, f, i);
	...
	function qv(t, e, n) {
		...
		return (
			...
			He(i, i, n.position),
			Cs(
				[t.dataToCoord(e), (n.labelOffset || 0) + (n.labelDirection || 1) * (n.labelMargin || 0)],
				i
			)
		);
	}
	function jv(t, e, n, i, r, o) {
		var a = mA.innerTextLayout(n.rotation, 0, n.labelDirection);
		(n.labelMargin = r.get(['label', 'margin'])),
			Uv(e, i, r, o, {
				position: qv(i.axis, t, n),
				align: a.textAlign,
	...
	function Jv(t, e, n) {
		if (!Uy.node) {
			var i = e.getZr();
			$A(i).records || ($A(i).records = {}), ty(i, e);
			var r = $A(i).records[t] || ($A(i).records[t] = {});
			r.handler = n;
		}
	}
	function ty(t, e) {
	...
	function sy(t, e, n) {
		var i = t.currTrigger,
			r = [t.x, t.y],
			o = t,
			a = t.dispatchAction || pm(n.dispatchAction, n),
			s = e.getComponent('axisPointer').coordSysAxesInfo;
		if (s) {
			yy(r) && (r = ay({ seriesIndex: o.seriesIndex, dataIndex: o.dataIndex }, e).point);
			var l = yy(r),
				u = o.axesInfo,
				h = s.axesInfo,
				c = 'leave' === i || yy(r),
				...
				f = {},
				d = { list: [], map: {} },
				g = { showPointer: S(hy, f), showTooltip: S(cy, d) };
				...
				v(h, function (t, e) {
					...
					n &&
						...
						v(n.axesInfo, function (e, i) {
							...
							if (e !== t && r) {
								var o = r.value;
								n.mapper && (o = t.axis.scale.parse(n.mapper(o, vy(e), vy(t)))), (y[t.key] = o);
							}
						});
				}),
				v(y, function (t, e) {
		...
		return (
			v(e.seriesModels, function (e) {
				...
				if (e.getAxisTooltipData) {
					...
					if (
						((u = e.getData().indicesOfNearest(h[0], t, 'category' === n.type ? 0.5 : null)),
						!u.length)
					)
						return;
				...
				if (null != l && isFinite(l)) {
					var p = t - l,
						f = Math.abs(p);
					a >= f &&
						((a > f || (p >= 0 && 0 > s)) && ((a = f), (s = p), (r = l), (o.length = 0)),
						v(u, function (t) {
							o.push({
	...
	function py(t, e, n) {
		...
		v(e, function (e, n) {
			...
			o
				...
				'show' === r.status &&
					i.push({ axisDim: e.axis.dim, axisIndex: e.axis.model.componentIndex, value: r.value });
		});
	}
	function fy(t, e, n, i) {
		if (yy(e) || !t.list.length) return void i({ type: 'hideTip' });
	...
	function my(t) {
		wA.registerAxisPointerClass('CartesianAxisPointer', jA),
			t.registerComponentModel(KA),
			t.registerComponentView(JA),
			t.registerPreprocessor(function (t) {
				if (t) {
			...
			t.registerProcessor(t.PRIORITY.PROCESSOR.STATISTIC, function (t, e) {
				t.getComponent('axisPointer').coordSysAxesInfo = uv(t, e);
			}),
			t.registerAction(
	...
	function My(t, e, n) {
		...
		p(['left', 'right'], a) > -1
			? ((l += 'top:50%'),
			  (u += 'translateY(-50%) rotate(' + (o = 'left' === a ? -225 : -45) + 'deg)'))
			: ((l += 'left:50%'),
	...
	function Ty(t, e) {
		...
		return (
			e ||
				((i = ' ' + t + 's ' + n),
				(r += Uy.transformSupported ? ',' + oP + i : ',left' + i + ',top' + i)),
			rP + ':' + r
		);
	}
	function Cy(t, e, n) {
	...
	function Dy(t, e, n) {
		...
		return (
			...
			i.push(Iy(h)),
			null != c && i.push('padding:' + pM(c).join('px ') + 'px'),
			i.join(';') + ';'
		);
	}
	...
	function Py(t) {
		var e = Ay(t.shadowBlur || 0),
			n = Ay(t.shadowOffsetX || 0),
			i = Ay(t.shadowOffsetY || 0);
		return { left: Ay(e - n), right: Ay(e + n), top: Ay(e - i), bottom: Ay(e + i) };
	}
	function Ly(t, e, n, i) {
	...
	function Oy(t, e, n) {
		var i,
			r = e.ecModel;
		n ? ((i = new YS(n, r, r)), (i = new YS(e.option, i, r))) : (i = e);
		for (var o = t.length - 1; o >= 0; o--) {
			var a = t[o];
			a &&
				(a instanceof YS && (a = a.get('tooltip', !0)),
				C(a) && (a = { formatter: a }),
				a && (i = new YS(a, i, r)));
		}
		return i;
	...
	function Ry(t, e) {
		return t.dispatchAction || pm(e.dispatchAction, e);
	}
	...
	function Vy(t) {
		Xf(my),
			t.registerComponentModel(eP),
			t.registerComponentView(hP),
	...
	'object' == typeof wx && 'function' == typeof wx.getSystemInfoSync
		? ((Uy.wxa = !0), (Uy.touchEventsSupported = !0))
		: 'undefined' == typeof document && 'undefined' != typeof self
		? (Uy.worker = !0)
		: 'undefined' == typeof navigator
		? ((Uy.node = !0), (Uy.svgSupported = !0))
		: n(navigator.userAgent, Uy);
	var Xy = 12,
		Yy = 'sans-serif',
		qy = Xy + 'px ' + Yy,
		jy = 20,
		...
		Qy = {
			...
			measureText: (function () {
				...
				return function (n, i) {
					if (!t) {
						var r = Qy.createCanvas();
						t = r && r.getContext('2d');
					}
					if (t) return e !== i && (e = t.font = i || qy), t.measureText(n);
					(n = n || ''), (i = i || qy);
					var o = /(\d+)px/.exec(i),
						a = (o && +o[1]) || Xy,
						s = 0;
		...
		om = nm.slice,
		am = nm.map,
		sm = function () {}.constructor,
		lm = sm ? sm.prototype : null,
		um = '__proto__',
		hm = 2311,
		cm = Qy.createCanvas,
		pm = lm && T(lm.bind) ? lm.call.bind(lm.bind) : b,
		fm = '__ec_primitive__',
		dm = (function () {
			function t() {
				this.data = {};
			...
			return (
				(t.prototype._dragStart = function (t) {
					...
					e &&
						...
						(this._x = t.offsetX),
						(this._y = t.offsetY),
						this.handler.dispatchToElement(new Mm(e, t), 'dragstart', t.event));
				}),
				(t.prototype._drag = function (t) {
					...
					if (e) {
						...
						(this._x = n),
							(this._y = i),
							e.drift(r, o, t),
							this.handler.dispatchToElement(new Mm(e, t), 'drag', t.event);
						var a = this.handler.findHover(n, i, e).target,
							s = this._dropTarget;
						(this._dropTarget = a),
							e !== a &&
								(s && a !== s && this.handler.dispatchToElement(new Mm(s, t), 'dragleave', t.event),
								a && a !== s && this.handler.dispatchToElement(new Mm(a, t), 'dragenter', t.event));
					}
				}),
				(t.prototype._dragEnd = function (t) {
					var e = this._draggingTarget;
					e && (e.dragging = !1),
						this.handler.dispatchToElement(new Mm(e, t), 'dragend', t.event),
						this._dropTarget &&
							this.handler.dispatchToElement(new Mm(this._dropTarget, t), 'drop', t.event),
		...
		Am = /([&<>"'])/g,
		Pm = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' },
		Lm = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
		Om = [],
		Rm = Uy.browser.firefox && +Uy.browser.version.split('.')[0] < 39,
		Em = function (t) {
		...
		zm = (function () {
			...
			return (
				...
				(t.prototype._recognize = function (t) {
					for (var e in Bm)
						if (Bm.hasOwnProperty(e)) {
							var n = Bm[e](this._track, t);
							if (n) return n;
						}
				}),
				t
		...
		jm = (function () {
			...
			return (
				(t.prototype.union = function (t) {
					...
					(this.width =
						isFinite(this.x) && isFinite(this.width)
							? Hm(t.x + t.width, this.x + this.width) - e
							: t.width),
						(this.height =
							isFinite(this.y) && isFinite(this.height)
								? Hm(t.y + t.height, this.y + this.height) - n
								: t.height),
						(this.x = e),
						(this.y = n);
				}),
				...
				(t.prototype.intersect = function (e, n) {
					...
					if (n) {
						var f = 1 / 0,
							...
							x = Math.min(y, m);
						l > o || r > u
							? _ > d && ((d = _), v > g ? Fm.set(qm, -g, 0) : Fm.set(qm, v, 0))
							: f > _ && ((f = _), v > g ? Fm.set(Ym, g, 0) : Fm.set(Ym, -v, 0)),
							h > s || a > c
								? x > d && ((d = x), m > y ? Fm.set(qm, 0, -y) : Fm.set(qm, 0, m))
								: f > _ && ((f = _), m > y ? Fm.set(Ym, 0, y) : Fm.set(Ym, 0, -m));
					}
					return n && Fm.copy(n, p ? Ym : qm), p;
				}),
				...
				(t.applyTransform = function (e, n, i) {
					...
					(Gm.x = Um.x = n.x),
						(Gm.y = Xm.y = n.y),
						(Wm.x = Xm.x = n.x + n.width),
						(Wm.y = Um.y = n.y + n.height),
						Gm.transform(i),
						Xm.transform(i),
						Wm.transform(i),
						Um.transform(i),
						(e.x = Vm(Gm.x, Wm.x, Um.x, Xm.x)),
						(e.y = Vm(Gm.y, Wm.y, Um.y, Xm.y));
					var l = Hm(Gm.x, Wm.x, Um.x, Xm.x),
						u = Hm(Gm.y, Wm.y, Um.y, Xm.y);
		...
		t_ = (function (t) {
			...
			return (
				...
				(n.prototype.mousemove = function (t) {
					...
					var a = (this._hovered = i ? new $m(e, n) : this.findHover(e, n)),
						s = a.target,
						l = this.proxy;
					...
					if ((Ze(i, r, t, e, n), this._pointerSize && !r.target)) {
						for (
							...
							h === n ||
								...
								(Jm.copy(h.getBoundingRect()),
								h.transform && Jm.applyTransform(h.transform),
								Jm.intersect(l) && o.push(h));
						}
						if (o.length)
				...
				(n.prototype.processGesture = function (t, e) {
					this._gestureMgr || (this._gestureMgr = new zm());
		...
		t_.prototype[t] = function (e) {
			...
			if (
				...
				if (
					...
					!this._downPoint ||
					wm(this._downPoint, [e.zrX, e.zrY]) > 4
				)
					return;
					...
					if (!t.ignore || n) {
						...
						if (t.childrenRef) {
							for (var a = t.childrenRef(), s = 0; s < a.length; s++) {
								var l = a[s];
								t.__dirty && (l.__dirty |= r_), this._updateAndAddDisplayable(l, e, n);
							}
							t.__dirty = 0;
						} else {
							var u = t;
	...
	var u_ = e_,
		h_ = {
			...
			bounceInOut: function (t) {
				return 0.5 > t ? 0.5 * h_.bounceIn(2 * t) : 0.5 * h_.bounceOut(2 * t - 1) + 0.5;
			}
		},
		c_ = Math.pow,
		p_ = Math.sqrt,
		...
		w_ = (function () {
			...
			return (
				...
				(t.prototype.setEasing = function (t) {
					(this.easing = t), (this.easingFunc = T(t) ? t : h_[t] || Mn(t));
				}),
				t
			);
		})(),
		...
		M_ = (function () {
			function t(t) {
				(this._list = new S_()), (this._maxSize = 10), (this._map = {}), (this._maxSize = t);
			}
			return (
				(t.prototype.put = function (t, e) {
					...
					if (null == i[t]) {
						...
						a ? (a.value = e) : (a = new b_(e)), (a.key = t), n.insertEntry(a), (i[t] = a);
					}
					return r;
				}),
				(t.prototype.get = function (t) {
		...
		P_ =
			((function () {
				return Uy.hasGlobalWindow && T(window.btoa)
					? function (t) {
		...
		V_ = (function () {
			...
			return (
				...
				(t.prototype.addKeyframe = function (t, e, n) {
					...
					0 === r ? (this.valType = a) : (a !== this.valType || a === N_) && (o = !0),
						(this.discrete = this.discrete || o);
					var p = { time: t, value: s, rawValue: e, percent: 0 };
					return n && ((p.easing = n), (p.easingFunc = T(n) ? n : h_[n] || Mn(n))), i.push(p), p;
				}),
				(t.prototype.prepare = function (t, e) {
					...
					for (
						...
						var h = n[u],
							...
							p = o.value;
						(h.percent = h.time / t),
							a || (s && u !== r - 1 ? ei(c, p, i) : l && ti(c.colorStops, p.colorStops));
					}
					if (
						!a &&
						i !== B_ &&
						...
						for (var f = n[0].value, u = 0; r > u; u++)
							i === L_
								...
								: i === E_
								? (n[u].additiveValue = Qn([], n[u].value, f, -1))
								: ai(i) &&
								  (n[u].additiveValue =
										i === O_ ? Qn([], n[u].value, f, -1) : Jn([], n[u].value, f, -1));
					}
				}),
				(t.prototype.step = function (t, e) {
					if (!this._finished) {
						...
						if (i && r) {
							...
							var m = o ? this._additiveValue : c ? F_ : t[h];
							if (((!ai(s) && !c) || m || (m = this._additiveValue = []), this.discrete))
								t[h] = 1 > v ? i.rawValue : r.rawValue;
							else if (ai(s)) s === O_ ? Kn(m, i[a], r[a], v) : $n(m, i[a], r[a], v);
							else if (oi(s)) {
								var _ = i[a],
									x = r[a],
									w = s === z_;
				...
				(t.prototype._addToTarget = function (t) {
					...
					e === L_
						? (t[n] = t[n] + i)
						: e === E_
						? (En(t[n], F_), Qn(F_, F_, i, 1), (t[n] = ii(F_)))
						: e === O_
						? Qn(t[n], t[n], i, 1)
						: e === R_ && Jn(t[n], t[n], i, 1);
				}),
					...
					for (var r = this._tracks, o = 0; o < n.length; o++) {
						...
						if (!s) {
							...
							if (u) {
								var h = u.keyframes,
									c = h[h.length - 1];
								(l = c && c.value), u.valType === E_ && l && (l = ii(l));
		...
		G_ = (function (t) {
			...
			return (
				...
				(n.prototype._startLoop = function () {
					function t() {
						e._running && (u_(t), !e._paused && e.update());
					}
					var e = this;
					(this._running = !0), u_(t);
				}),
		...
		Y_ = { mouse: ['mousemove', 'mouseup'], pointer: ['pointermove', 'pointerup'] },
		q_ = !1,
		j_ = (function () {
			function t(t, e) {
		...
		Z_ = {
			...
			wheel: function (t) {
				(q_ = !0), (t = Pe(this.dom, t)), this.trigger('mousewheel', t);
			},
			mousewheel: function (t) {
				q_ || ((t = Pe(this.dom, t)), this.trigger('mousewheel', t));
			},
			touchstart: function (t) {
				(t = Pe(this.dom, t)),
					...
					Z_.mousemove.call(this, t),
					Z_.mousedown.call(this, t);
			},
			...
			touchend: function (t) {
				(t = Pe(this.dom, t)),
					...
					Z_.mouseup.call(this, t),
					+new Date() - +this.__lastTouchMoment < W_ && Z_.click.call(this, t);
			},
			pointerdown: function (t) {
				Z_.mousedown.call(this, t);
			},
			pointermove: function (t) {
				li(t) || Z_.mousemove.call(this, t);
			},
			pointerup: function (t) {
				Z_.mouseup.call(this, t);
			},
			pointerout: function (t) {
				li(t) || Z_.mouseout.call(this, t);
			}
		};
	...
	var K_ = {
			pointermove: function (t) {
				li(t) || K_.mousemove.call(this, t);
			},
			pointerup: function (t) {
				K_.mouseup.call(this, t);
			},
			mousemove: function (t) {
				this.trigger('mousemove', t);
			},
		...
		Q_ = (function (t) {
			function n(e, n) {
				...
				return (
					...
					(i.dom = e),
					(i.painterRoot = n),
					(i._localHandlerScope = new $_(e, Z_)),
					U_ && (i._globalHandlerScope = new $_(document, K_)),
					fi(i, i._localHandlerScope),
					i
				);
			}
			return (
				e(n, t),
				(n.prototype.dispose = function () {
					vi(this._localHandlerScope), U_ && vi(this._globalHandlerScope);
				}),
				(n.prototype.setCursor = function (t) {
					this.dom.style && (this.dom.style.cursor = t || 'default');
				}),
				(n.prototype.__togglePointerCapture = function (t) {
					if (((this.__mayPointerCapture = null), U_ && +this.__pointerCapturing ^ +t)) {
		...
		cx = (function () {
			...
			return (
				...
				(t.prototype.updateTransform = function () {
					...
					return e || t
						? ((n = n || Be()),
						  e ? this.getLocalTransform(n) : ox(n),
						  t && (e ? Ve(n, t, n) : Fe(n, t)),
						  (this.transform = n),
				...
				(t.prototype.decomposeTransform = function () {
					if (this.transform) {
						var t = this.parent,
							e = this.transform;
						t && t.transform && (Ve(lx, t.invTransform, e), (e = lx));
						var n = this.originX,
							i = this.originY;
						(n || i) &&
							((ux[4] = n), (ux[5] = i), Ve(lx, e, ux), (lx[4] -= n), (lx[5] -= i), (e = lx)),
				...
				(t.prototype.getLineScale = function () {
					...
					return t && hx(t[0] - 1) > 1e-10 && hx(t[3] - 1) > 1e-10
						? Math.sqrt(hx(t[0] * t[3] - t[2] * t[1]))
						: 1;
				}),
		...
		_x = (function () {
			...
			return (
					...
					if (e && (!e.ignore || t)) {
						...
						if ((r.copyTransform(e), null != n.position)) {
							...
							u.copy(n.layoutRect ? n.layoutRect : this.getBoundingRect()),
								...
								this.calculateTextPosition ? this.calculateTextPosition(yx, n, u) : Ci(yx, n, u),
								(r.x = yx.x),
								(r.y = yx.y),
								(o = yx.align),
								(a = yx.verticalAlign);
				...
				(t.prototype.getOutsideFill = function () {
					return this.__zr && this.__zr.isDarkMode() ? ix : nx;
				}),
				...
				(t.prototype._innerSaveToNormal = function (t) {
					...
					e || (e = this._normalState = {}),
						...
						this._savePrimaryToNormal(t, e, gx);
				}),
					...
					if (o || !r) {
						...
						if (!(p(s, t) >= 0) || (!e && 1 !== s.length)) {
							...
							return (
								...
								this.markRedraw(),
								!h && this.__inHover && (this._toggleHoverLayerFlag(!1), (this.__dirty &= ~r_)),
								u
							);
						}
					}
				...
				(t.prototype.useStates = function (t, e, n) {
					if (t.length) {
						...
						d && d.useStates(t, e, c),
							...
							this.markRedraw(),
							!c && this.__inHover && (this._toggleHoverLayerFlag(!1), (this.__dirty &= ~r_));
				...
				(t.prototype._applyStateObj = function (t, e, n, i, r, o) {
					...
					for (var s = {}, l = !1, u = 0; u < gx.length; u++) {
						var c = gx[u],
							p = r && vx[c];
						e && null != e[c]
							? p
	...
	var xx = (function (t) {
		...
		return (
			...
			(n.prototype.getBoundingRect = function (t) {
				for (
					var e = new jm(0, 0, 0, 0), n = t || this._children, i = [], r = null, o = 0;
					o < n.length;
					o++
				) {
					var a = n[o];
					if (!a.ignore && !a.invisible) {
						...
						l
							? (jm.applyTransform(e, s, l), (r = r || e.clone()), r.union(e))
	...
	var bx = {},
		...
		Mx = (function () {
			function t(t, e, n) {
				...
				var r = new l_(),
					o = n.renderer || 'canvas';
				bx[o] || (o = w(bx)[0]), (n.useDirtyRect = null == n.useDirtyRect ? !1 : n.useDirtyRect);
				var a = new bx[o](e, r, n, t),
					s = n.ssr || a.ssrOnly;
				(this.storage = r), (this.painter = a);
				var l,
					u = Uy.node || Uy.worker || s ? null : new Q_(a.getViewportRoot(), a.root),
					h = n.useCoarsePointer,
					c = null == h || 'auto' === h ? Uy.touchEventsSupported : !!h,
					p = 44;
				c && (l = N(n.pointerSize, p)),
					(this.handler = new t_(r, a, u, a.root, l)),
					(this.animation = new G_({
						stage: {
							update: s
								? null
								: function () {
			...
			return (
				...
				(t.prototype.clear = function () {
					for (var t = this.storage.getRoots(), e = 0; e < t.length; e++)
						t[e] instanceof xx && t[e].removeSelfFromZr(this);
		...
		Px = ('undefined' != typeof console && console.warn && console.log, 'series\x00'),
		Lx = '\x00_ec_\x00',
		Ox = [
			'fontStyle',
			'fontWeight',
		...
		Rx = lr(),
		Ex = { useDefault: !0, enableAll: !1, enableNone: !1 },
		zx = '.',
		Bx = '___EC__COMPONENT__CONTAINER___',
		Nx = '___EC__EXTENDED_CLASS___',
		Fx = Math.round(10 * Math.random()),
		Vx = [
			['fill', 'color'],
			['shadowBlur'],
			['shadowOffsetX'],
		...
		Zx = '__zr_style_' + Math.round(10 * Math.random()),
		Kx = {
			shadowBlur: 0,
			shadowOffsetX: 0,
			shadowOffsetY: 0,
	...
	var Qx = ['z', 'z2', 'invisible'],
		...
		tw = (function (t) {
			...
			return (
				...
				(n.prototype.getPaintRect = function () {
					...
					if (!this._paintRect || this.__dirty) {
						var e = this.transform,
							...
							o = i.shadowOffsetX || 0,
							a = i.shadowOffsetY || 0;
						(t = this._paintRect || (this._paintRect = new jm(0, 0, 0, 0))),
							e ? jm.applyTransform(t, n, e) : t.copy(n),
							(r || o || a) &&
				...
				(n.prototype.setPrevPaintRect = function (t) {
					t
						? ((this._prevPaintRect = this._prevPaintRect || new jm(0, 0, 0, 0)),
				...
				(n.prototype.dirtyStyle = function (t) {
					t || this.markRedraw(), (this.__dirty |= o_), this._rect && (this._rect = null);
				}),
				(n.prototype.dirty = function () {
					this.dirtyStyle();
				}),
				(n.prototype.styleChanged = function () {
					return !!(this.__dirty & o_);
				}),
				...
				(n.prototype._innerSaveToNormal = function (e) {
					...
					e.style && !n.style && (n.style = this._mergeStyle(this.createStyle(), this.style)),
						this._savePrimaryToNormal(e, n, Qx);
				}),
				(n.prototype._applyStateObj = function (e, n, i, r, o, a) {
					...
					for (var d = this.__inHover ? Jx : Qx, c = 0; c < d.length; c++) {
						var p = d[c];
		...
		cw = [],
		pw = [],
		fw = { M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7 },
		dw = [],
		gw = [],
		vw = [],
		yw = [],
		...
		Tw = Math.PI,
		Cw = 2 * Tw,
		Iw = 'undefined' != typeof Float32Array,
		Dw = [],
		kw = (function () {
			function t(t) {
				(this.dpr = 1),
			...
			return (
				...
				(t.prototype.setScale = function (t, e, n) {
					(n = n || 0),
						n > 0 && ((this._ux = Mw(n / tx / t) || 0), (this._uy = Mw(n / tx / e) || 0));
				}),
				...
				(t.prototype.lineTo = function (t, e) {
					...
					if ((this.addData(fw.L, t, e), this._ctx && r && this._ctx.lineTo(t, e), r))
				...
				(t.prototype.arc = function (t, e, n, i, r, o) {
					this._drawPendingPt(), (Dw[0] = i), (Dw[1] = r), mo(Dw, o), (i = Dw[0]), (r = Dw[1]);
					var a = r - i;
					return (
						this.addData(fw.A, t, e, n, n, i, a, 0, o ? 0 : 1),
				...
				(t.prototype.rect = function (t, e, n, i) {
					return (
						...
						this.addData(fw.R, t, e, n, i),
						this
					);
				}),
				(t.prototype.closePath = function () {
					this._drawPendingPt(), this.addData(fw.Z);
					var t = this._ctx,
						e = this._x0,
						n = this._y0;
				...
				(t.prototype.setData = function (t) {
					var e = t.length;
					(this.data && this.data.length === e) || !Iw || (this.data = new Float32Array(e));
				...
				(t.prototype.appendPath = function (t) {
					...
					Iw && this.data instanceof Float32Array && (this.data = new Float32Array(i + n));
					for (var r = 0; e > r; r++)
				...
				(t.prototype.toStatic = function () {
					if (this._saveData) {
						...
						var t = this.data;
						t instanceof Array &&
							((t.length = this._len), Iw && this._len > 11 && (this.data = new Float32Array(t)));
					}
				}),
				(t.prototype.getBoundingRect = function () {
					(vw[0] = vw[1] = mw[0] = mw[1] = Number.MAX_VALUE),
						(yw[0] = yw[1] = _w[0] = _w[1] = -Number.MAX_VALUE);
					var t,
						e = this.data,
						n = 0,
						i = 0,
					...
					for (t = 0; t < this._len; ) {
						...
						switch ((s && ((n = e[t]), (i = e[t + 1]), (r = n), (o = i)), a)) {
							case fw.M:
								...
								break;
							case fw.L:
								po(n, i, e[t], e[t + 1], mw, _w), (n = e[t++]), (i = e[t++]);
								break;
							case fw.C:
								fo(n, i, e[t++], e[t++], e[t++], e[t++], e[t], e[t + 1], mw, _w),
									(n = e[t++]),
									(i = e[t++]);
								break;
							case fw.Q:
								go(n, i, e[t++], e[t++], e[t], e[t + 1], mw, _w), (n = e[t++]), (i = e[t++]);
								break;
							case fw.A:
								var l = e[t++],
									u = e[t++],
								...
								t += 1;
								var d = !e[t++];
								s && ((r = bw(p) * h + l), (o = Sw(p) * c + u)),
									vo(l, u, h, c, p, f, d, mw, _w),
									(n = bw(f) * h + l),
									(i = Sw(f) * c + u);
								break;
							case fw.R:
								...
								var g = e[t++],
									v = e[t++];
								po(r, o, r + g, o + v, mw, _w);
								break;
							case fw.Z:
								(n = r), (i = o);
						}
						me(vw, vw, mw), _e(yw, yw, _w);
					}
					return (
						0 === t && (vw[0] = vw[1] = yw[0] = yw[1] = 0),
						new jm(vw[0], vw[1], yw[0] - vw[0], yw[1] - vw[1])
					);
				}),
						...
						switch (p) {
							...
							case fw.C:
								var _ = t[c++],
									...
									w = t[c++],
									b = t[c++];
								(d = vn(r, o, _, x, g, v, w, b, 10)), (r = w), (o = b);
								break;
							case fw.Q:
								var _ = t[c++],
									x = t[c++],
							...
							case fw.A:
								...
								f && ((a = bw(I) * T + S), (s = Sw(I) * C + M)),
									(d = ww(T, C) * xw(Cw, Math.abs(D))),
									(r = bw(k) * T + S),
									(o = Sw(k) * C + M);
								break;
							case fw.R:
						...
						t: for (var w = 0; v > w; ) {
							...
							switch (
								...
								case fw.C:
									...
									if (y) {
										...
										if (m + C > h) {
											...
											dn(r, k, P, O, I, dw),
												dn(o, A, L, R, I, gw),
												t.bezierCurveTo(dw[1], gw[1], dw[2], gw[2], dw[3], gw[3]);
											break t;
										}
										m += C;
									}
								...
								case fw.Q:
									...
									if (y) {
										...
										if (m + C > h) {
											...
											wn(r, k, P, I, dw),
												wn(o, A, L, I, gw),
												t.quadraticCurveTo(dw[1], gw[1], dw[2], gw[2]);
											break t;
										}
										m += C;
									}
								...
								case fw.A:
									...
									if (
										(U && t.ellipse ? t.ellipse(E, z, B, N, H, F, X, G) : t.arc(E, z, W, F, X, G),
										Y)
									)
										break t;
									S && ((n = bw(F) * B + E), (i = Sw(F) * N + z)),
										(r = bw(X) * B + E),
										(o = Sw(X) * N + z);
									break;
								case fw.R:
									...
									if (y) {
										...
										if (m + C > h) {
											...
											t.moveTo(a, s),
												t.lineTo(a + xw(Z, q), s),
												(Z -= q),
												Z > 0 && t.lineTo(a + q, s + xw(Z, j)),
												(Z -= j),
												Z > 0 && t.lineTo(a + ww(q - Z, 0), s + j),
												(Z -= q),
												Z > 0 && t.lineTo(a, s + ww(j - Z, 0));
											break t;
										}
										m += C;
									}
		...
		Fw = px.concat(['invisible', 'culling', 'z', 'z2', 'zlevel', 'parent']),
		Vw = (function (t) {
			function n(e) {
				return t.call(this, e) || this;
			}
			return (
				...
				(n.prototype.update = function () {
					...
					if (i.decal) {
						...
						for (var s = 0; s < Fw.length; ++s) r[Fw[s]] = this[Fw[s]];
						r.__dirty |= r_;
			...
			return (
				...
				(n.prototype.getBoundingRect = function () {
					...
					if (!this._rect) {
						var e = t.text;
						null != e ? (e += '') : (e = '');
						var n = wi(e, t.font, t.textAlign, t.textBaseline);
		...
		Xw = (function (t) {
			...
			return (
				...
				(n.prototype.getBoundingRect = function () {
					...
					return (
						this._rect ||
							(this._rect = new jm(t.x || 0, t.y || 0, this.getWidth(), this.getHeight())),
						this._rect
					);
				}),
				n
	...
	var Kw = { fill: '#000' },
		...
		Jw = (function (t) {
			function n(e) {
				var n = t.call(this) || this;
				return (n.type = 'text'), (n._children = []), (n._defaultStyle = Kw), n.attr(e), n;
			}
			return (
				e(n, t),
				(n.prototype.childrenRef = function () {
				...
				(n.prototype.getBoundingRect = function () {
					if ((this.styleChanged() && this._updateSubTexts(), !this._rect)) {
						for (
							var t = new jm(0, 0, 0, 0), e = this._children, n = [], i = null, r = 0;
							r < e.length;
							r++
						) {
							var o = e[r],
				...
				(n.prototype._updatePlainTexts = function () {
					...
					(m += c / 2),
						n && ((y = Xo(f, g, n)), 'top' === v ? (m += n[0]) : 'bottom' === v && (m -= n[2]));
					for (
						var w = 0,
							b = !1,
							S = Uo(('fill' in t) ? t.fill : ((b = !0), p.fill)),
							M = Wo(
								('stroke' in t) ? t.stroke : a || (p.autoStroke && !b) ? null : ((w = $w), p.stroke)
							),
						...
						var k = this._getOrCreateChild(Gw),
							A = k.createStyle();
						k.useStyle(A),
							(A.text = h[D]),
							(A.x = y),
							...
							C &&
								k.setBoundingRect(
									new jm(bi(A.x, t.width, A.textAlign), Si(A.y, I, A.textBaseline), u, I)
								);
					}
				}),
				(n.prototype._updateRichTexts = function () {
					...
					a && ((d += a[3]), (g += a[0]));
					var v = d + i;
					qo(t) && this._renderBackground(t, t, p, f, r, o);
				...
				(n.prototype._placeToken = function (t, e, n, i, r, o, a) {
					...
					var f = this._getOrCreateChild(Gw),
						d = f.createStyle();
					f.useStyle(d);
					...
					var w = t.contentWidth,
						b = t.contentHeight;
					f.setBoundingRect(new jm(bi(d.x, w, d.textAlign), Si(d.y, b, d.textBaseline), w, b));
				}),
				(n.prototype._renderBackground = function (t, e, n, i, r, o) {
					...
					if (p || t.lineHeight || (u && h)) {
						(a = this._getOrCreateChild(Zw)), a.useStyle(a.createStyle()), (a.style.fill = null);
						var g = a.shape;
				...
				(n.makeFont = function (t) {
					...
					return (
						Vo(t) &&
							(e = [t.fontStyle, t.fontWeight, No(t.fontSize), t.fontFamily || 'sans-serif'].join(
								' '
							)),
		...
		tb = { left: !0, right: 1, center: 1 },
		eb = { top: 1, bottom: 1, middle: 1 },
		nb = ['fontStyle', 'fontWeight', 'fontSize', 'fontFamily'],
		ib = Lr(),
		rb = function (t, e, n, i) {
			if (i) {
				var r = ib(i);
		...
		hb = 1,
		cb = 2,
		pb = ['emphasis', 'blur', 'select'],
		fb = ['normal', 'emphasis', 'blur', 'select'],
		db = 10,
		gb = 9,
		vb = 'highlight',
		yb = 'downplay',
		...
		xb = 'toggleSelect',
		wb = new M_(100),
		bb = ['emphasis', 'blur', 'select'],
		Sb = { itemStyle: 'getItemStyle', lineStyle: 'getLineStyle', areaStyle: 'getAreaStyle' },
		Mb = kw.CMD,
		Tb = [[], [], []],
		Cb = Math.sqrt,
		Ib = Math.atan2,
	...
	var pS = (function (t) {
			...
			return (
				...
				(n.prototype.getBoundingRect = function () {
					return this._updatePathDirty.call(this), Vw.prototype.getBoundingRect.call(this);
				}),
				n
			);
		})(Vw),
		...
		xS = (function () {
			function t(t, e) {
				...
				for (var n = 0; 4 > n; n++) this._corners[n] = new Fm();
				for (var n = 0; 2 > n; n++) this._axes[n] = new Fm();
			...
			return (
				(t.prototype.fromBoundingRect = function (t, e) {
					...
					Fm.sub(i[0], n[1], n[0]), Fm.sub(i[1], n[3], n[0]), i[0].normalize(), i[1].normalize();
				...
				(t.prototype.intersect = function (t, e) {
					...
					return (
						mS.set(1 / 0, 1 / 0),
						_S.set(0, 0),
						!this._intersectCheckOneSide(this, t, mS, _S, i, 1) && ((n = !1), i)
							? n
							: !this._intersectCheckOneSide(t, this, mS, _S, i, -1) && ((n = !1), i)
							? n
							: (i || Fm.copy(e, n ? mS : _S), n)
					);
				}),
				(t.prototype._intersectCheckOneSide = function (t, e, n, i, r, o) {
					for (var a = !0, s = 0; 2 > s; s++) {
						var l = this._axes[s];
						if (
							(this._getProjMinMaxOnAxis(s, t._corners, vS),
							this._getProjMinMaxOnAxis(s, e._corners, yS),
							vS[1] < yS[0] || vS[0] > yS[1])
						) {
							if (((a = !1), r)) return a;
							var u = Math.abs(yS[0] - vS[1]),
								h = Math.abs(vS[0] - yS[1]);
							Math.min(u, h) > i.len() && (h > u ? Fm.scale(i, l, -u * o) : Fm.scale(i, l, h * o));
						} else if (n) {
							var u = Math.abs(yS[0] - vS[1]),
								h = Math.abs(vS[0] - yS[1]);
							Math.min(u, h) < n.len() && (h > u ? Fm.scale(n, l, u * o) : Fm.scale(n, l, -h * o));
						}
					}
					return a;
				}),
		...
		bS = (function (t) {
			...
			return (
				...
				(n.prototype.getBoundingRect = function () {
					if (!this._rect) {
						for (
							var t = new jm(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0;
		...
		FS = (function () {
			...
			return (
				(t.prototype.getTextColor = function (t) {
					var e = this.ecModel;
					return this.getShallow('color') || (!t && e ? e.get(zS) : null);
				}),
				...
				(t.prototype.getTextRect = function (t) {
					for (
						...
						e[BS[n]] = this.getShallow(BS[n]);
					return NS.useStyle(e), NS.update(), NS.getBoundingRect();
				}),
				t
			);
		})(),
	...
	Wr(YS), Yr(YS), d(YS, GS), d(YS, XS), d(YS, Gx), d(YS, FS);
	var qS = Math.round(10 * Math.random()),
		jS = {
			time: {
				month: [
					'January',
	...
	var nM = 1e3,
		...
		hM = ['year', 'month', 'day', 'hour', 'minute', 'second', 'millisecond'],
		cM = [
			'year',
			'half-year',
			'quarter',
		...
		gM = v,
		vM = ['left', 'right', 'top', 'bottom', 'width', 'height'],
		yM = [
			['width', 'left', 'right'],
			['height', 'top', 'bottom']
		],
		mM = Nl,
		_M = (S(Nl, 'vertical'), S(Nl, 'horizontal'), Lr()),
		xM = (function (t) {
			function n(e, n, i) {
			...
			return (
				...
				(n.prototype.mergeDefaultAndTheme = function (t, e) {
					var n = Vl(this),
						i = n ? Gl(t) : {},
						r = e.getTheme();
					l(t, r.get(this.mainType)), l(t, this.getDefaultOption()), n && Hl(t, i, n);
				}),
				(n.prototype.mergeOption = function (t) {
					l(this.option, t, !0);
					var e = Vl(this);
					e && Hl(this.option, t, e);
				}),
	...
	var bM,
			...
			aria: {
				decal: {
					decals: [
						...
						{ color: MM, dashArrayX: [1, 0], dashArrayY: [4, 3], rotation: -Math.PI / 4 },
						{
							color: MM,
							dashArrayX: [
								[6, 6],
		...
		CM = q(['tooltip', 'label', 'itemName', 'itemId', 'itemGroupId', 'seriesName']),
		IM = 'original',
		DM = 'arrayRows',
		kM = 'objectRows',
		AM = 'keyedColumns',
		...
		GM = (function (t) {
			...
			return (
				...
				(n.prototype.init = function (t, e, n, i, r, o) {
					(i = i || {}),
						(this.option = null),
						(this._theme = new YS(i)),
						(this._locale = new YS(r)),
				...
				(n.prototype._mergeOption = function (t, e) {
					function n(e) {
						var n = Ql(this, e, fr(t[e])),
							a = r.get(e),
							s = a ? (c && c.get(e) ? 'replaceMerge' : 'normalMerge') : 'replaceAll',
							l = yr(a, n, s);
						kr(l, e, xM), (i[e] = null), r.set(e, null), o.set(e, 0);
						var u,
							p = [],
							f = [],
							d = 0;
						v(
							...
							function (t, n) {
								...
								if (r) {
									var o = 'series' === e,
										a = xM.getClass(e, t.keyInfo.subType, !o);
									if (!a) return;
									if ('tooltip' === e) {
										if (u) return;
										u = !0;
					...
					Xl(this),
						...
						c &&
							c.each(function (t, e) {
								xM.hasClass(e) && !u.get(e) && (a.push(e), u.set(e, !0));
							}),
						xM.topologicalTravel(a, xM.getAllClassMainTypes(), n, this),
						this._seriesIndices || bM(this);
				}),
				(n.prototype.getOption = function () {
					...
					return (
						v(t, function (e, n) {
							if (xM.hasClass(n)) {
								for (var i = fr(e), r = i.length, o = !1, a = r - 1; a >= 0; a--)
				...
				(n.prototype.eachComponent = function (t, e, n) {
					...
					if (T(t)) {
						...
						for (
							var a = C(t) ? i.get(t) : k(t) ? this.findComponents(t) : null, s = 0;
							a && s < a.length;
							s++
						) {
							var l = a[s];
				...
				(n.prototype.restoreData = function (t) {
					...
					var e = this._componentsMap,
						n = [];
					e.each(function (t, e) {
						xM.hasClass(e) && n.push(e);
					}),
						xM.topologicalTravel(n, xM.getAllClassMainTypes(), function (n) {
	...
	var WM,
			...
			return (
				...
				(t.prototype.getMediaOption = function () {
					...
					return (
						!r.length && i && (r = [-1]),
						r.length &&
							!hu(r, this._currentMediaIndices) &&
							(o = y(r, function (t) {
		...
		eT = v,
		nT = k,
		iT = ['areaStyle', 'lineStyle', 'nodeStyle', 'linkStyle', 'chordStyle', 'label', 'labelLine'],
		rT = [
			['x', 'left'],
			['y', 'top'],
			['x2', 'right'],
		...
		sT = (function () {
			function t(t) {
				(this.data = t.data || (t.sourceFormat === AM ? {} : [])),
					(this.sourceFormat = t.sourceFormat || LM),
					(this.seriesLayoutBy = t.seriesLayoutBy || OM),
				...
				if (e)
					for (var n = 0; n < e.length; n++) {
						var i = e[n];
						null == i.type && Kl(this, n) === EM.Must && (i.type = 'ordinal');
					}
			}
			return t;
		})(),
		lT = (function () {
			function t(t, e) {
				...
				n.sourceFormat === PM && ((this._offset = 0), (this._dimSize = e), (this._data = i)),
					qM(this, i, n);
			}
			return (
				...
				(t.internalField = (function () {
					...
					qM = function (t, e, o) {
						var a = o.sourceFormat,
							...
							c = YM[Uu(a, s)];
						if ((h(t, c), a === PM)) (t.getItem = n), (t.count = r), (t.fillStorage = i);
						else {
							var p = Hu(a, s);
							t.getItem = pm(p, null, e, l, u);
							var f = Gu(a, s);
							t.count = pm(f, null, e, l, u);
						}
					};
					var n = function (t, e) {
							(t -= this._offset), (e = e || []);
		...
		hT =
			((WM = {}),
			(WM[DM + '_' + OM] = function (t, e, n, i) {
				return t[i + e];
			}),
			(WM[DM + '_' + RM] = function (t, e, n, i, r) {
				i += e;
		...
		pT =
			((UM = {}),
			(UM[DM + '_' + OM] = function (t, e) {
				return Math.max(0, t.length - e);
			}),
			(UM[DM + '_' + RM] = function (t, e) {
				var n = t[0];
				return n ? Math.max(0, n.length - e) : 0;
			}),
			(UM[kM] = cT),
			(UM[AM] = function (t, e, n) {
				var i = n[0].name,
					r = t[i];
				return r ? r.length : 0;
			}),
		...
		vT = (function () {
			...
			return (
				...
				(t.prototype.getFormattedLabel = function (t, e, n, i, r, o) {
					...
					if (C(r)) {
						var u = Ll(r, s);
						return u.replace(gT, function (e, n) {
							var i = n.length,
								r = n;
			...
			return (
				...
				(t.prototype._doProgress = function (t, e, n, i, r) {
					mT.reset(e, n, i, r),
						...
						this._callingProgress({ start: e, end: n, count: n - e, next: mT.next }, this.context);
				}),
		...
		xT =
			((function () {
				function t(t, e) {
					...
					(this._opFn = _T[t]), (this._rvalFloat = ar(e));
				}
				return (
		...
		bT = q(),
		ST = 'undefined',
		MT = typeof Uint32Array === ST ? Array : Uint32Array,
		TT = typeof Uint16Array === ST ? Array : Uint16Array,
		CT = typeof Int32Array === ST ? Array : Int32Array,
		IT = typeof Float64Array === ST ? Array : Float64Array,
		DT = { float: IT, int: CT, ordinal: Array, number: Array, time: IT },
		kT = (function () {
			function t() {
				(this._chunks = []),
					(this._rawExtent = []),
			...
			return (
				(t.prototype.initData = function (t, e, n) {
					...
					var i = t.getSource(),
						r = (this.defaultDimValueGetter = jM[i.sourceFormat]);
				...
				(t.prototype.ensureCalculationDimension = function (t, e) {
					...
					return (
						(i[r] = { type: e }),
						n.set(t, r),
						(this._chunks[r] = new DT[e || 'float'](this._rawCount)),
						(this._rawExtent[r] = oh()),
						r
					);
				}),
				...
				(t.prototype.appendValues = function (t, e) {
					...
					for (var h = [], c = a; s > c; c++)
						for (var p = c - a, f = 0; r > f; f++) {
							var u = i[f],
								d = jM.arrayRows.call(this, t[p] || h, u.property, p, f);
							n[f][c] = d;
							var g = o[f];
				...
				(t.prototype.downSample = function (t, e, n, i) {
					for (
						var r = this.clone([t], !0),
							...
							u = this.count(),
							h = (r._rawExtent[t] = oh()),
							c = new (rh(this._rawCount))(Math.ceil(u / s)),
							p = 0,
							f = 0;
						u > f;
						f += s
				...
				(t.prototype.clone = function (e, n) {
					...
					if (o) for (var a = 0; a < r.length; a++) i._chunks[a] = o[a] ? ah(r[a]) : r[a];
					else i._chunks = r;
					return (
			...
			return (
					...
					if (uh(n)) {
						...
						if (r) {
							...
							u.prepareSource(),
								...
								(s = l.sourceFormat),
								(e = [u._getVersionSign()]);
						} else (a = o.get('data', !0)), (s = P(a) ? PM : IM), (e = []);
						...
						t = g ? [Lu(a, { seriesLayoutBy: p, sourceHeader: f, dimensions: d }, s)] : [];
					} else {
						var v = n;
						if (r) {
				...
				(t.prototype._innerGetDataStore = function (t, e, n) {
					...
					if (!a) {
						...
						uh(this._sourceHost) && s
							? (a = s._innerGetDataStore(t, e, n))
							: ((a = new kT()), a.initData(new lT(e, t.length), t)),
							(o[n] = a);
					}
					return a;
				}),
		...
		ET = Lr(),
		zT = '__universalTransitionEnabled',
		BT = (function (t) {
			function n() {
				var e = (null !== t && t.apply(this, arguments)) || this;
			...
			return (
				...
				(n.prototype.init = function (t, e, n) {
					(this.seriesIndex = this.componentIndex),
						(this.dataTask = qu({ count: Lh, reset: Oh })),
						(this.dataTask.context = { model: this }),
						this.mergeDefaultAndTheme(t, n);
					var i = (ET(this).sourceManager = new AT(this));
					i.prepareSource();
					var r = this.getInitialData(t, n);
					Eh(r, this),
						(this.dataTask.context.data = r),
						(ET(this).dataBeforeProcessed = r),
						Ah(this),
				...
				(n.prototype.mergeOption = function (t, e) {
					...
					var n = Vl(this);
					n && Hl(this.option, t, n);
					var i = ET(this).sourceManager;
				...
				(n.prototype.getColorFromPalette = function (t, e, n) {
					var i = this.ecModel,
						r = FM.prototype.getColorFromPalette.call(this, t, e, n);
	...
	d(BT, vT), d(BT, FM), Xr(BT, xM);
	var NT = (function () {
		function t() {
			(this.group = new xx()), (this.uid = Qs('viewComponent'));
		}
		return (
			(t.prototype.init = function () {}),
		...
		HT = (function () {
			function t() {
				(this.group = new xx()),
					...
					(this.renderTask = qu({ plan: Hh, reset: Gh })),
	...
	var GT,
		...
		UT = '\x00__throttleOriginMethod',
		XT = '\x00__throttleRate',
		YT = '\x00__throttleType',
		qT = Lr(),
		jT = { itemStyle: Kr(WS, !0), lineStyle: Kr(VS, !0) },
		ZT = { lineStyle: 'stroke', itemStyle: 'fill' },
		KT = {
			createOnAllSeries: !0,
			performRawSeries: !0,
			reset: function (t, e) {
						...
						dataEach: n.hasItemOption
							? function (t, e) {
									...
									if (n && n[i]) {
										...
										h(s, a),
											$T.option.decal &&
												(t.setItemVisual(e, 'decal', $T.option.decal),
												($T.option.decal.dirty = !0)),
		...
		eC = (function () {
			...
			return (
				...
				(t.prototype._createSeriesStageTask = function (t, e, n, i) {
					function r(e) {
						var r = e.uid,
							l = s.set(r, (a && a.get(r)) || qu({ plan: Jh, reset: tc, count: nc }));
						(l.context = {
							model: e,
							ecModel: n,
							api: i,
				...
				(t.prototype._createOverallStageTask = function (t, e, n, i) {
					function r(t) {
						var e = t.uid,
							n = l.set(e, (s && s.get(e)) || ((p = !0), qu({ reset: Kh, onDirty: Qh })));
					...
					var o = this,
						a = (e.overallTask = e.overallTask || qu({ reset: Zh }));
				...
				(t.wrapStageHandler = function (t, e) {
					return (
						T(t) && (t = { overallReset: t, seriesType: ic(t) }),
	...
	rc(iC, GM),
		rc(rC, KM),
		(iC.eachSeriesByType = iC.eachRawSeriesByType =
			function (t) {
				GT = t;
			}),
		(iC.eachComponent = function (t) {
			'series' === t.mainType && t.subType && (GT = t.subType);
		});
	var oC = [
			'#37A2DA',
			'#32C5E9',
		...
		cC = {
			...
			legend: { textStyle: { color: sC } },
			textStyle: { color: sC },
			title: { textStyle: { color: '#EEF1FA' }, subtextStyle: { color: '#B9B8CE' } },
			toolbox: { iconStyle: { borderColor: sC } },
			dataZoom: {
				borderColor: '#71708A',
				textStyle: { color: sC },
			...
			visualMap: { textStyle: { color: sC } },
			timeline: {
				lineStyle: { color: sC },
				label: { color: sC },
				controlStyle: { color: sC, borderColor: sC }
			},
			calendar: {
				itemStyle: { color: lC },
				dayLabel: { color: sC },
	...
	var pC = (function () {
		...
		fC = ['symbol', 'symbolSize', 'symbolRotate', 'symbolOffset'],
		dC = fC.concat(['symbolKeepAspect']),
		gC = {
			createOnAllSeries: !0,
			performRawSeries: !0,
			reset: function (t, e) {
				...
				if ((t.legendIcon && i.setVisual('legendIcon', t.legendIcon), t.hasSymbolVisual)) {
					for (var r = {}, o = {}, a = !1, s = 0; s < fC.length; s++) {
						var l = fC[s],
							u = t.get(l);
						T(u) ? ((a = !0), (o[l] = u)) : (r[l] = u);
					}
		...
		vC = {
			...
			reset: function (t, e) {
				function n(t, e) {
					for (var n = t.getItemModel(e), i = 0; i < dC.length; i++) {
						var r = dC[i],
							o = n.getShallow(r, !0);
		...
		yC = Math.round(9 * Math.random()),
		mC = 'function' == typeof Object.defineProperty,
		_C = (function () {
			function t() {
				this._id = '__ec_inner_' + yC++;
			}
			return (
				(t.prototype.get = function (t) {
	...
	var IC = Vw.extend({
			...
			buildPath: function (t, e, n) {
				...
				if ('none' !== i) {
					var r = CC[i];
					r || ((i = 'rect'), (r = CC[i])),
						TC[i](e.x, e.y, e.width, e.height, r.shape),
						r.buildPath(t, r.shape, n);
				}
			}
		}),
		DC = new kw(!0),
		kC = ['shadowBlur', 'shadowOffsetX', 'shadowOffsetY'],
		AC = [
			['lineCap', 'butt'],
			['lineJoin', 'miter'],
			['miterLimit', 10]
		...
		iI = 7e3,
		rI = {
			PROCESSOR: { FILTER: XC, SERIES_FILTER: WC, STATISTIC: qC },
			VISUAL: {
				LAYOUT: jC,
				PROGRESSIVE_LAYOUT: ZC,
				GLOBAL: KC,
				CHART: $C,
				POST_CHART_LAYOUT: tI,
				COMPONENT: QC,
				BRUSH: eI,
				CHART_ITEM: JC,
				ARIA: nI,
		...
		oI = '__flagInMainProcess',
		aI = '__pendingUpdate',
		sI = '__needsUpdateStatus',
		lI = /^[a-zA-Z0-9_]+$/,
		uI = '__connectUpdateStatus',
		hI = 0,
		cI = 1,
		pI = 2,
		fI = (function (t) {
	...
	var gI,
		...
		OI = (function (t) {
			function n(e, n, i) {
				...
				(o._ssr = i.ssr),
					(o._throttledZrFlush = Wh(pm(h.flush, h), 17)),
					(n = s(n)),
					n && Du(n, !0),
					(o._theme = n),
					(o._locale = il(i.locale || eM)),
					(o._coordSysMgr = new QM());
				var c = (o._api = kI(o));
				return (
					on(VI, r),
					on(NI, r),
					(o._scheduler = new eC(o, c, NI, VI)),
					(o._messageCenter = new fI()),
					o._initEvents(),
					(o.resize = pm(o.resize, o)),
			...
			return (
				...
				(n.prototype._onframe = function () {
					if (!this._disposed) {
						...
						if (this[aI]) {
							var e = this[aI].silent;
							this[oI] = !0;
							try {
								gI(this), mI.update.call(this, null, this[aI].updateParams);
							} catch (n) {
								throw ((this[oI] = !1), (this[aI] = null), n);
							}
							this._zr.flush(),
								(this[oI] = !1),
								(this[aI] = null),
				...
				(n.prototype.setOption = function (t, e, n) {
					if (!this[oI] && !this._disposed) {
						...
						if (
							...
							var a = new tT(this._api),
								s = this._theme,
								l = (this._model = new GM());
							(l.scheduler = this._scheduler),
								(l.ssr = this._ssr),
								l.init(null, null, null, s, this._locale, a);
						}
						this._model.setOption(t, { replaceMerge: r }, FI);
						var u = { seriesTransition: o, optionChanged: !0 };
						if (n)
							(this[aI] = { silent: i, updateParams: u }), (this[oI] = !1), this.getZr().wakeUp();
						else {
							try {
								gI(this), mI.update.call(this, null, u);
							} catch (h) {
								throw ((this[aI] = null), (this[oI] = !1), h);
							}
				...
				(n.prototype.getDevicePixelRatio = function () {
					return this._zr.painter.dpr || (Uy.hasGlobalWindow && window.devicePixelRatio) || 1;
				}),
					...
					if (!this._disposed) {
						...
						if (UI[n]) {
							...
							return (
								...
								v(c, function (t) {
									var e = new Xw({ style: { x: t.left * p - a, y: t.top * p - l, image: t.dom } });
									y.add(e);
								}),
								y.refreshImmediately(),
				...
				(n.prototype.convertToPixel = function (t, e) {
					return _I(this, 'convertToPixel', t, e);
				}),
				(n.prototype.convertFromPixel = function (t, e) {
					return _I(this, 'convertFromPixel', t, e);
				}),
					...
					if (!this[oI] && !this._disposed) {
						...
						if ((this._loadingFX && this._loadingFX.resize(), e)) {
							var n = e.resetOption('media'),
								i = t && t.silent;
							this[aI] && (null == i && (i = this[aI].silent), (n = !0), (this[aI] = null)),
								(this[oI] = !0);
							try {
								n && gI(this),
									mI.update.call(this, {
							...
							(this[oI] = !1), bI.call(this, i), SI.call(this, i);
						}
					}
				}),
				(n.prototype.showLoading = function (t, e) {
					if (
						!this._disposed &&
						(k(t) && ((e = t), (t = '')), (t = t || 'default'), this.hideLoading(), GI[t])
					) {
						var n = GI[t](this._api, e),
							i = this._zr;
				...
				(n.prototype.dispatchAction = function (t, e) {
					if (!this._disposed && (k(e) || (e = { silent: !!e }), zI[t.type] && this._model)) {
						if (this[oI]) return void this._pendingActions.push(t);
						var n = e.silent;
						wI.call(this, t, n);
						var i = e.flush;
						i ? this._zr.flush() : i !== !1 && Uy.browser.weChat && this._throttledZrFlush(),
							bI.call(this, n),
							SI.call(this, n);
					}
				}),
				(n.prototype.updateLabelLayout = function () {
					NC.trigger('series:layoutlabels', this._model, this._api, { updatedSeries: [] });
				}),
				(n.prototype.appendData = function (t) {
					if (!this._disposed) {
						var e = t.seriesIndex,
				...
				(n.internalField = (function () {
					...
					function i(t) {
						...
						t.selected && t.states.select && e.push('select'),
							t.hoverState === cb && t.states.emphasis
								? e.push('emphasis')
								: t.hoverState === hb && t.states.blur && e.push('blur'),
							t.useStates(e);
					}
					function r(t, e) {
						var n = t._zr,
					...
					function u(t, e) {
						...
						e.eachRendered(function (t) {
							if (t.states && t.states.emphasis) {
								if (hs(t)) return;
								if ((t instanceof Vw && Ha(t), t.__dirty)) {
									var e = t.prevStates;
									e && t.useStates(e);
								}
								if (r) {
					...
					(gI = function (t) {
						var e = t._scheduler;
						e.restorePipelines(t._model), e.prepareStageTasks(), vI(t, !0), vI(t, !1), e.plan();
					}),
						(vI = function (t, e) {
							function n(t) {
								...
								if (!h) {
									var c = Vr(t.type),
										p = e ? NT.getClass(c.main, c.sub) : HT.getClass(c.sub);
												...
												if (Va(n))
													if (e instanceof BT)
														...
														n.type === vb &&
															o &&
															!n.notBlur &&
															Sa(e.mainType, e.componentIndex, t._api),
															a &&
																v(a, function (t) {
																	n.type === vb ? da(t) : ga(t);
																});
													}
												else Fa(n) && e instanceof BT && (Da(e, n, t._api), ka(e), PI(t));
										},
										t
									),
								a &&
						...
						(mI = {
							prepareAndUpdate: function (t) {
								gI(this), mI.update.call(this, t, { optionChanged: null != t.newOption });
							},
							update: function (e, n) {
								var i = this._model,
									r = this._api,
							...
							updateView: function (e) {
								...
								n &&
									...
									HT.markUpdateMethod(e, 'updateView'),
									t(n),
									this._scheduler.performVisualTasks(n, e, { setDirty: !0 }),
									CI(this, n, this._api, e, {}),
									NC.trigger('afterupdate', n, this._api));
							},
							updateVisual: function (e) {
								...
								i &&
									...
									HT.markUpdateMethod(e, 'updateVisual'),
									t(i),
									...
									NC.trigger('afterupdate', i, this._api));
							},
							updateLayout: function (t) {
								mI.update.call(this, t);
							}
						}),
						(_I = function (t, e, n, i) {
							if (!t._disposed)
								...
								v(f, function (e) {
									if (
										...
										var i = Rr(t),
											...
											l = o ? r.keys()[0] : 'series';
										yI(n, u, e, l), PI(n);
									} else _ ? (yI(n, u, e, 'series'), PI(n)) : p && yI(n, u, e, p.main, p.sub);
								}),
								'none' !== u && !x && !_ && !p)
							)
								try {
									this[aI]
										? (gI(this), mI.update.call(this, t), (this[aI] = null))
										: mI[u].call(this, t);
								} catch (w) {
									throw ((this[oI] = !1), w);
								}
						...
						(TI = function (t, e) {
							t.on('mouseover', function (t) {
								var n = t.target,
									i = hc(n, Ba);
								i && (Ca(i, t, e._api), PI(e));
							})
								.on('mouseout', function (t) {
									var n = t.target,
										i = hc(n, Ba);
									i && (Ia(i, t, e._api), PI(e));
								})
								.on('click', function (t) {
									var n = t.target,
										i = hc(
						...
						(DI = function (t, e, n, i, s, c) {
							var p = t._scheduler;
							(s = h(s || {}, { updatedSeries: e.getSeries() })),
								NC.trigger('series:beforeupdate', e, n, s);
							var f = !1;
							e.eachSeries(function (e) {
								var n = t._chartsMap[e.__viewId];
								n.__alive = !0;
								...
								NC.trigger('series:layoutlabels', e, n, s),
								NC.trigger('series:transition', e, n, s),
								e.eachSeries(function (e) {
									var n = t._chartsMap[e.__viewId];
									a(e, n), u(e, n);
								}),
								r(t, e),
								NC.trigger('series:afterupdate', e, n, s);
						}),
						(PI = function (t) {
							(t[sI] = !0), t.getZr().wakeUp();
						}),
						(LI = function (t) {
							t[sI] &&
	...
	_p(KC, KT),
		...
		cp(UC, ku),
		wp('default', jh),
		gp({ type: vb, event: vb, update: vb }, Q),
		gp({ type: yb, event: yb, update: yb }, Q),
		gp({ type: mb, event: mb, update: mb }, Q),
		gp({ type: _b, event: _b, update: _b }, Q),
		gp({ type: xb, event: xb, update: xb }, Q),
		up('light', aC),
		up('dark', cC);
	var $I,
		QI,
		...
		oD = (function () {
			function t(t, e, n, i, r, o) {
				(this._old = t),
					(this._new = e),
					(this._oldKeyGetter = n || Cp),
					(this._newKeyGetter = i || Cp),
					(this.context = r),
		...
		lD = Lr(),
		uD = { float: 'f', int: 'i', ordinal: 'o', number: 'n', time: 't' },
		hD = (function () {
			function t(t) {
			...
			return (
				...
				(t.prototype._updateDimOmitted = function (t) {
					(this._dimOmitted = t), t && (this._dimNameMap || (this._dimNameMap = Op(this.source)));
				}),
		...
		cD = k,
		pD = y,
		fD = 'undefined' == typeof Int32Array ? Array : Int32Array,
		dD = 'e\x00\x00',
		gD = -1,
		vD = [
			'hasItemOption',
		...
		mD = (function () {
			function t(t, e) {
				...
				for (var r = {}, o = [], a = {}, s = !1, l = {}, u = 0; u < n.length; u++) {
					var h = n[u],
						c = C(h) ? new sD({ name: h }) : h instanceof sD ? h : new sD(h),
						p = c.name;
			...
			return (
				...
				(t.prototype.initData = function (t, e, n) {
					var i,
						r = this;
					if ((t instanceof kT && (i = t), !i)) {
						var o = this.dimensions,
							a = Pu(t) || g(t) ? new lT(t, o.length) : t;
						i = new kT();
						var s = pD(o, function (t) {
					...
					(this._store = i),
						...
						(this._dimSummary = Ip(this, this._schema)),
				...
				(t.prototype.appendValues = function (t, e) {
					...
					if ((this._updateOrdinalMeta(), e))
						for (var a = i; r > a; a++) {
							var s = a - i;
							(this._nameList[a] = e[s]), o && iD(this, a);
						}
				}),
				...
				(t.prototype._shouldMakeIdFromName = function () {
					...
					return null == this._idDimIdx && t.getSource().sourceFormat !== PM && !t.fillStorage;
				}),
				(t.prototype._doInit = function (t, e) {
					if (!(t >= e)) {
						...
						if (this._shouldMakeIdFromName()) for (var u = t; e > u; u++) iD(this, u);
						$I(this);
					}
				}),
				...
				(t.prototype.setCalculationInfo = function (t, e) {
					cD(t) ? h(this._calculationInfo, t) : (this._calculationInfo[t] = e);
				}),
				(t.prototype.getName = function (t) {
					var e = this.getRawIndex(t),
						n = this._nameList[e];
					return (
						null == n && null != this._nameDimIdx && (n = JI(this, this._nameDimIdx, e)),
						null == n && (n = ''),
						n
					);
				}),
				...
				(t.prototype.each = function (t, e, n) {
					T(t) && ((n = e), (e = t), (t = []));
					var i = n || this,
						r = pD(tD(t), this._getStoreDimIndex, this);
					this._store.each(r, i ? pm(e, i) : e);
				}),
				(t.prototype.filterSelf = function (t, e, n) {
					T(t) && ((n = e), (e = t), (t = []));
					var i = n || this,
						r = pD(tD(t), this._getStoreDimIndex, this);
					return (this._store = this._store.filter(r, i ? pm(e, i) : e)), this;
				}),
				(t.prototype.selectRange = function (t) {
					var e = this,
						n = {},
				...
				(t.prototype.map = function (t, e, n, i) {
					var r = n || i || this,
						o = pD(tD(t), this._getStoreDimIndex, this),
						a = nD(this);
					return (a._store = this._store.map(o, r ? pm(e, r) : e)), a;
				}),
				(t.prototype.modify = function (t, e, n, i) {
					var r = n || i || this,
						o = pD(tD(t), this._getStoreDimIndex, this);
					this._store.modify(o, r ? pm(e, r) : e);
				}),
				(t.prototype.downSample = function (t, e, n, i) {
					var r = nD(this);
				...
				(t.prototype.setVisual = function (t, e) {
					(this._visual = this._visual || {}), cD(t) ? h(this._visual, t) : (this._visual[t] = e);
				}),
				...
				(t.prototype.setItemVisual = function (t, e, n) {
					...
					(this._itemVisuals[t] = i), cD(e) ? h(i, e) : (i[e] = n);
				}),
				(t.prototype.clearAllVisual = function () {
					(this._visual = {}), (this._itemVisuals = []);
				}),
				(t.prototype.setLayout = function (t, e) {
					cD(t) ? h(this._layout, t) : (this._layout[t] = e);
				}),
				...
				(t.prototype.setItemGraphicEl = function (t, e) {
					...
					rb(n, this.dataType, t, e), (this._graphicEls[t] = e);
				}),
				...
				(t.prototype.cloneShallow = function (e) {
					return (
						e ||
							(e = new t(
								this._schema ? this._schema : pD(this.dimensions, this._getDimInfo, this),
								this.hostModel
							)),
						eD(e, this),
					...
					($I = function (t) {
						...
						v(e, function (n, i) {
							var r = t._dimInfos[i],
								...
								a = t._store;
							if (o) {
								n = e[i] = new fD(o.categories.length);
								for (var s = 0; s < n.length; s++) n[s] = gD;
						...
						(nD = function (e) {
							var n = new t(
								e._schema ? e._schema : pD(e.dimensions, e._getDimInfo, e),
								e.hostModel
							);
							return eD(n, e), n;
						}),
						(eD = function (t, e) {
							v(vD.concat(e.__wrappedMethods || []), function (n) {
								e.hasOwnProperty(n) && (t[n] = e[n]);
							}),
		...
		xD = {
			cartesian2d: function (t, e, n, i) {
				var r = t.getReferringComponents('xAxis', Ex).models[0],
					o = t.getReferringComponents('yAxis', Ex).models[0];
				(e.coordSysDims = ['x', 'y']),
					n.set('x', r),
					n.set('y', o),
			...
			singleAxis: function (t, e, n, i) {
				var r = t.getReferringComponents('singleAxis', Ex).models[0];
				(e.coordSysDims = ['single']),
					n.set('single', r),
					Hp(r) && (i.set('single', r), (e.firstCategoryDimIndex = 0));
			},
			polar: function (t, e, n, i) {
				var r = t.getReferringComponents('polar', Ex).models[0],
		...
		MD = (function (t) {
			...
			return (
				...
				(n.prototype.contain = function (t) {
					return (
						(t = this.parse(t)), of(t, this._extent) && null != this._ordinalMeta.categories[t]
					);
				}),
				(n.prototype.normalize = function (t) {
					return (t = this._getTickNumber(this.parse(t))), af(t, this._extent);
				}),
				(n.prototype.scale = function (t) {
					return (t = Math.round(sf(t, this._extent))), this.getRawOrdinalNumber(t);
				}),
	...
	var TD = Ui,
		CD = (function (t) {
			...
			return (
				...
				(n.prototype.contain = function (t) {
					return of(t, this._extent);
				}),
				(n.prototype.normalize = function (t) {
					return af(t, this._extent);
				}),
				(n.prototype.scale = function (t) {
					return sf(t, this._extent);
				}),
				...
				(n.prototype.getTicks = function (t) {
					...
					if (!e) return o;
					var a = 1e4;
					n[0] < i[0] && o.push(t ? { value: TD(i[0] - e, r) } : { value: n[0] });
					for (
						var s = i[0];
						s <= i[1] && (o.push({ value: s }), (s = TD(s + e, r)), s !== o[o.length - 1].value);

					)
						if (o.length > a) return [];
					var l = o.length ? o[o.length - 1].value : i[1];
					return n[1] > l && o.push(t ? { value: TD(l + e, r) } : { value: n[1] }), o;
				}),
				...
				(n.prototype.calcNiceExtent = function (t) {
					...
					t.fixMin || (e[0] = TD(Math.floor(e[0] / r) * r)),
						t.fixMax || (e[1] = TD(Math.ceil(e[1] / r) * r));
				}),
	...
	wD.registerClass(CD);
	var ID = 'undefined' != typeof Float32Array,
		DD = ID ? Float32Array : Array,
		kD = '__ec_stack_',
		AD = function (t, e, n, i) {
			for (; i > n; ) {
				var r = (n + i) >>> 1;
		...
		PD = (function (t) {
			...
			return (
				...
				(n.prototype.getLabel = function (t) {
					...
					return hl(
						t.value,
						uM[ul(sl(this._minLevelUnit))] || uM.second,
						e,
				...
				(n.prototype.getTicks = function () {
					...
					var i = this.getSetting('useUTC'),
						r = Tf(this._minLevelUnit, this._approxInterval, i, e);
					return (n = n.concat(r)), n.push({ value: e[1], level: 0 }), n;
				}),
				(n.prototype.calcNiceExtent = function (t) {
					var e = this._extent;
					if ((e[0] === e[1] && ((e[0] -= oM), (e[1] += oM)), e[1] === -1 / 0 && 1 / 0 === e[0])) {
						var n = new Date();
						(e[1] = +new Date(n.getFullYear(), n.getMonth(), n.getDate())), (e[0] = e[1] - oM);
					}
					this.calcNiceTicks(t.splitNumber, t.minInterval, t.maxInterval);
				}),
				(n.prototype.calcNiceTicks = function (t, e, n) {
					...
					var o = LD.length,
						a = Math.min(AD(LD, this._approxInterval, 0, o), o - 1);
					(this._interval = LD[a][1]), (this._minLevelUnit = LD[Math.max(a - 1, 0)][0]);
				}),
				(n.prototype.parse = function (t) {
					return D(t) ? t : +tr(t);
				}),
				(n.prototype.contain = function (t) {
					return of(this.parse(t), this._extent);
				}),
				(n.prototype.normalize = function (t) {
	...
	var OD = wD.prototype,
		...
		VD = (function (t) {
			function n() {
				var e = (null !== t && t.apply(this, arguments)) || this;
				return (e.type = 'log'), (e.base = 10), (e._originalScale = new CD()), (e._interval = 0), e;
			}
			return (
				e(n, t),
				(n.prototype.getTicks = function (t) {
					...
					return y(
						...
						function (t) {
							var e = t.value,
								r = Ui(ND(this.base, e));
							return (
								(r = e === n[0] && this._fixMin ? Cf(r, i[0]) : r),
								(r = e === n[1] && this._fixMax ? Cf(r, i[1]) : r),
								{ value: r }
							);
						},
						this
				...
				(n.prototype.setExtent = function (t, e) {
					var n = FD(this.base);
					(t = FD(Math.max(0, t)) / n), (e = FD(Math.max(0, e)) / n), RD.setExtent.call(this, t, e);
				}),
				(n.prototype.getExtent = function () {
					var t = this.base,
						e = OD.getExtent.call(this);
					(e[0] = ND(t, e[0])), (e[1] = ND(t, e[1]));
					var n = this._originalScale,
						i = n.getExtent();
					return (
						this._fixMin && (e[0] = Cf(e[0], i[0])), this._fixMax && (e[1] = Cf(e[1], i[1])), e
					);
				}),
				(n.prototype.unionExtent = function (t) {
					this._originalScale.unionExtent(t);
					var e = this.base;
					(t[0] = FD(t[0]) / FD(e)), (t[1] = FD(t[1]) / FD(e)), OD.unionExtent.call(this, t);
				}),
				(n.prototype.unionExtentFromData = function (t, e) {
					this.unionExtent(t.getApproximateExtent(e));
				}),
				(n.prototype.calcNiceTicks = function (t) {
					...
					if (!(1 / 0 === n || 0 >= n)) {
						...
						var o = [Ui(BD(e[0] / i) * i), Ui(zD(e[1] / i) * i)];
						(this._interval = i), (this._niceExtent = o);
					}
				}),
				(n.prototype.calcNiceExtent = function (t) {
					RD.calcNiceExtent.call(this, t), (this._fixMin = t.fixMin), (this._fixMax = t.fixMax);
				}),
				(n.prototype.parse = function (t) {
					return t;
				}),
				(n.prototype.contain = function (t) {
					return (t = FD(t) / FD(this.base)), of(t, this._extent);
				}),
				(n.prototype.normalize = function (t) {
					return (t = FD(t) / FD(this.base)), af(t, this._extent);
				}),
				(n.prototype.scale = function (t) {
					return (t = sf(t, this._extent)), ND(this.base, t);
				}),
				(n.type = 'log'),
				n
			);
		...
		HD = VD.prototype;
	(HD.getMinorTicks = RD.getMinorTicks), (HD.getLabel = RD.getLabel), wD.registerClass(VD);
	var GD = (function () {
			function t(t, e, n) {
			...
			return (
				(t.prototype._prepareParams = function (t, e, n) {
					...
					T(r)
						? (this._modelMinNum = Df(t, r({ min: n[0], max: n[1] })))
						: 'dataMin' !== r && (this._modelMinNum = Df(t, r));
					var o = (this._modelMaxRaw = e.get('max', !0));
					if (
						(T(o)
							? (this._modelMaxNum = Df(t, o({ min: n[0], max: n[1] })))
							: 'dataMax' !== o && (this._modelMaxNum = Df(t, o)),
						i)
					)
		...
		WD = { min: '_determinedMin', max: '_determinedMax' },
		UD = { min: '_dataMin', max: '_dataMax' },
		XD = (function () {
			function t() {}
			return (
		...
		YD = { isDimensionStacked: Up, enableDataStack: Gp, getStackedDimension: Xp },
		qD = (Object.freeze || Object)({
			createList: Hf,
			getLayoutRect: Fl,
			dataStack: YD,
			createScale: Gf,
			mixinAxisModelCommonMethods: Wf,
			getECData: ib,
			createTextStyle: Uf,
			createDimensions: Ep,
			createSymbol: pc,
		...
		jD = [],
		ZD = {
			registerPreprocessor: hp,
			registerProcessor: cp,
			registerPostInit: pp,
			registerPostUpdate: fp,
			registerUpdateLifecycle: dp,
			registerAction: gp,
			registerCoordinateSystem: vp,
			registerLayout: mp,
			registerVisual: _p,
			registerTransform: KI,
			registerLoading: wp,
			registerMap: Sp,
			registerImpl: Qc,
			PRIORITY: rI,
			...
			registerSubTypeDefaulter: function (t, e) {
				xM.registerSubTypeDefaulter(t, e);
			},
		...
		ek = (function (t) {
			...
			return (
				...
				(n.prototype.getBoundingRect = function (t) {
					...
					return (
						...
						(isFinite(n[0]) && isFinite(n[1]) && isFinite(i[0]) && isFinite(i[1])) ||
							(n[0] = n[1] = i[0] = i[1] = 0),
						(e = new jm(n[0], n[1], i[0] - n[0], i[1] - n[1])),
						t || (this._rect = e),
						e
					);
				}),
					...
					t: for (var i = 0, r = n.length; r > i; i++) {
						...
						if ('polygon' === o.type) {
							var a = o.exterior,
								s = o.interiors;
							if (qf(a, t[0], t[1])) {
								for (var l = 0; l < (s ? s.length : 0); l++) if (qf(s[l], t[0], t[1])) continue t;
								return !0;
							}
						}
					}
				...
				(n.prototype.transformTo = function (t, e, n, i) {
					...
					n ? i || (i = n / o) : (n = o * i);
					for (
						var a = new jm(t, e, n, i), s = r.calculateTransform(a), l = this.geometries, u = 0;
						u < l.length;
						u++
					) {
						var h = l[u];
		...
		ik = (Object.freeze || Object)({ parse: tr, format: hl }),
		...
		uk = (function () {
			...
			return (
				...
				(t.prototype.dataToCoord = function (t, e) {
					...
					return (
						(t = i.normalize(t)),
						this.onBand && 'ordinal' === i.type && ((n = n.slice()), gd(n, i.count())),
						Gi(t, lk, n, e)
					);
				}),
		...
		Ck = (function () {
			...
			return (
				...
				(t.prototype._addLabel = function (t, e, n, i, r) {
					...
					jm.applyTransform(u, u, l),
						l
							? bk.setLocalTransform(l)
							: ((bk.x = bk.y = bk.rotation = bk.originX = bk.originY = 0),
							  (bk.scaleX = bk.scaleY = 1));
					var h,
						c = i.__hostTarget;
					if (c) {
						h = c.getBoundingRect().plain();
						var p = c.getComputedTransform();
						jm.applyTransform(h, h, p);
					}
				...
				(t.prototype.updateLayoutConfig = function (t) {
					...
					for (var n = t.getWidth(), i = t.getHeight(), r = 0; r < this._labelList.length; r++) {
						var o = this._labelList[r],
							...
							l = o.defaultAttr,
							u = void 0;
						(u = T(o.layoutOption) ? o.layoutOption(Vd(o, s)) : o.layoutOption),
							(u = u || {}),
				...
				(t.prototype.processLabelsOverall = function () {
					...
					v(this._chartViewList, function (e) {
						...
						e.group.traverse(function (e) {
							...
							var o = !i,
								a = e.getTextContent();
							!o && a && (o = Sk(a).needsUpdateLabelLine),
				...
				(t.prototype._animateLabels = function (t, e) {
					...
					if (
						...
						(t.forceLabelAnimation ||
							(!n.ignore && !n.invisible && !t.disableLabelAnimation && !hs(t)))
					) {
						var r = Sk(n),
							o = r.oldLayout,
							a = ib(t),
						...
						if (((r.oldLayout = l), n.states.select)) {
							...
							Hd(f, l, Tk), Hd(f, n.states.select, Tk);
						}
						if (n.states.emphasis) {
							var d = (r.oldLayoutEmphasis = {});
							Hd(d, l, Tk), Hd(d, n.states.emphasis, Tk);
						}
						$s(n, s, u, e, e);
					}
	...
	var Dk = (function (t) {
			function n(e, n, i) {
				...
				var o;
				(i = i || tx),
					'string' == typeof e ? (o = Wd(e, n, i)) : k(e) && ((o = e), (e = o.id)),
					(r.id = e),
					(r.dom = o);
				var a = o.style;
				return (
			...
			return (
				...
				(n.prototype.createBackBuffer = function () {
					var t = this.dpr;
					(this.domBack = Wd('back-' + this.id, this.painter, t)),
					...
					for (
						...
						if (h) {
							var c = h.shouldBePainted(n, i, !0, !0),
								p = h.__isRendered && (h.__dirty & r_ || !c) ? h.getPrevPaintRect() : null;
							p && r(p);
							var f = c && (h.__dirty & r_ || !h.__isRendered) ? h.getPaintRect() : null;
							f && r(f);
						}
					}
					...
					function i(t, n, i, r) {
						if ((o.clearRect(t, n, i, r), e && 'transparent' !== e)) {
							...
							if (O(e)) {
								...
								(a = (s && e.__canvasGradient) || mc(o, e, { x: 0, y: 0, width: i, height: r })),
		...
		Ok = (function () {
			function t(t, e, n) {
				...
				(this._opts = n = h({}, n || {})),
					(this.dpr = n.devicePixelRatio || tx),
				...
				if (i) {
					...
					var p = (this._domRoot = Xd(this._width, this._height));
					t.appendChild(p);
				}
			}
			return (
				...
				(t.prototype._paintHoverList = function (t) {
					...
					if ((n && n.clear(), e)) {
						for (
							...
							var a = t[o];
							a.__inHover &&
								(n || (n = this._hoverlayer = this.getLayer(kk)),
								i || ((i = n.ctx), i.save()),
								Wc(i, a, r, o === e - 1));
						}
						i && i.restore();
				...
				(t.prototype.getLayer = function (t, e) {
					this._singleCanvas && !this._needsManuallyCompositing && (t = Ak);
					var n = this._layers[t];
					return (
						n ||
							((n = new Dk('zr_' + t, this, this.dpr)),
							(n.zlevel = t),
							(n.__builtin__ = !0),
							this._layerConfig[t]
								? l(n, this._layerConfig[t], !0)
								: this._layerConfig[t - Pk] && l(n, this._layerConfig[t - Pk], !0),
							e && (n.virtual = e),
				...
				(t.prototype._updateLayerStatus = function (t) {
					...
					for (o = 0; o < t.length; o++) {
						...
						r !== u && ((r = u), (l = 0)),
							i.incremental
								? ((h = this.getLayer(u + Lk, this._needsManuallyCompositing)),
								  (h.incremental = !0),
								  (l = 1))
								: (h = this.getLayer(u + (l > 0 ? Pk : 0), this._needsManuallyCompositing)),
				...
				(t.prototype.resize = function (t, e) {
					if (this._domRoot.style) {
						...
						(this._width = t), (this._height = e), this.getLayer(Ak).resize(t, e);
					}
					return this;
				}),
				...
				(t.prototype.getRenderedCanvas = function (t) {
					if (((t = t || {}), this._singleCanvas && !this._compositeManually))
						return this._layers[Ak].dom;
					var e = new Dk('image', this, t.pixelRatio || this.dpr);
		...
		Rk = (function (t) {
			...
			return (
				...
				(n.prototype.init = function (e, n, i) {
					t.prototype.init.call(this, e, n, i), (this._sourceManager = new AT(this)), lh(this);
				}),
				...
				(n.type = 'dataset'),
				(n.defaultOption = { seriesLayoutBy: OM }),
				n
			);
		})(xM),
		Ek = (function (t) {
	...
	var zk = (function (t) {
			...
			return (
				e(n, t),
				(n.prototype.getInitialData = function () {
					return jp(null, this, { useEncodeDefaulter: !0 });
				}),
		...
		Bk = (function (t) {
			...
			return (
				...
				(n.prototype._updateCommon = function (t, e, n, i, r) {
					...
					var w = dc(t.getItemVisual(e, 'symbolOffset'), n);
					...
					var k =
						null == d || d === !0 ? Math.max(1.1, 3 / this._sizeY) : isFinite(d) && d > 0 ? +d : 1;
					(D.scaleX = this._sizeX * k),
						(D.scaleY = this._sizeY * k),
				...
				(n.prototype.fadeOut = function (t, e, n) {
					...
					cs(i, { style: { opacity: 0 }, scaleX: 0, scaleY: 0 }, e, {
						dataIndex: r,
						cb: t,
						removeOpt: o
					});
		...
		Nk = (function () {
			function t(t) {
				(this.group = new xx()), (this._SymbolCtor = t || Bk);
			}
			return (
				(t.prototype.updateData = function (t, e) {
					(this._progressiveEls = null), (e = Qd(e));
					var n = this.group,
						i = t.hostModel,
						r = this._data,
						o = this._SymbolCtor,
						...
						t
							...
							.update(function (h, c) {
								var p = r.getItemGraphicEl(c),
									f = u(h);
								if (!$d(t, f, h, e)) return void n.remove(p);
			...
			return (
				...
				(n.prototype.buildPath = function (t, e) {
					var n = e.points,
						...
						r = n.length / 2;
					if (e.connectNulls) {
						for (; r > 0 && og(n[2 * r - 2], n[2 * r - 1]); r--);
						for (; r > i && og(n[2 * i], n[2 * i + 1]); i++);
					}
				...
				(n.prototype.getPointOn = function (t, e) {
					...
					for (
						var n, i, r = this.path, o = r.data, a = kw.CMD, s = 'x' === e, l = [], u = 0;
						u < o.length;
						...
						switch (h) {
							...
							case a.C:
								...
								var _ = s ? pn(n, c, f, g, t, l) : pn(i, p, d, v, t, l);
								if (_ > 0)
									for (var x = 0; _ > x; x++) {
										var w = l[x];
										if (1 >= w && w >= 0) {
											var m = s ? hn(i, p, d, v, w) : hn(n, c, f, g, w);
											return s ? [t, m] : [m, t];
										}
									}
								(n = g), (i = v);
			...
			return (
				...
				(n.prototype.buildPath = function (t, e) {
					var n = e.points,
						...
						a = e.smoothMonotone;
					if (e.connectNulls) {
						for (; o > 0 && og(n[2 * o - 2], n[2 * o - 1]); o--);
						for (; o > r && og(n[2 * r], n[2 * r + 1]); r++);
					}
					for (; o > r; ) {
						var s = ag(t, n, r, o, o, 1, e.smooth, a, e.connectNulls);
						ag(t, i, r + s - 1, s, o, -1, e.stackedOnSmooth, a, e.connectNulls),
							(r += s + 1),
							t.closePath();
					}
				}),
		...
		Xk = (function (t) {
			...
			return (
				...
				(n.prototype.render = function (t, e, n) {
					...
					var D = yg(a, r, n) || a.getVisual('style')[a.getVisual('drawType')];
					if (d && p.type === r.type && I === this._step) {
						m && !g
							? (g = this._newPolygon(u, w))
							: g && !m && (v.remove(g), (g = this._polygon = null)),
							h || this._initOrUpdateEndLabel(t, r, zl(D));
						var k = v.getClipPath();
						if (k) {
							var A = Tg(this, r, !1, t);
							us(k, { shape: A.shape }, t);
						} else v.setClipPath(Tg(this, r, !0, t));
						b &&
							f.updateData(a, {
								isIgnore: M,
								clipShape: C,
							...
							(hg(this._stackedOnPoints, w) && hg(this._points, u)) ||
								(y
									? this._doUpdateAnimation(a, w, r, n, I, _, S)
									: (I && ((u = gg(u, r, I, S)), w && (w = gg(w, r, I, S))),
									  d.setShape({ points: u }),
						...
						b &&
							...
							h || this._initOrUpdateEndLabel(t, r, zl(D)),
							v.setClipPath(Tg(this, r, !0, t));
					var P = t.getModel('emphasis'),
						L = P.get('focus'),
						O = P.get('blurScope'),
						R = P.get('disabled');
					if (
						(d.useStyle(c(s.getLineStyle(), { fill: 'none', stroke: D, lineJoin: 'bevel' })),
						Ea(d, t, 'lineStyle'),
						d.style.lineWidth > 0 && 'bolder' === t.get(['emphasis', 'lineStyle', 'width']))
					) {
						var E = d.getState('emphasis').style;
						E.lineWidth = +d.style.lineWidth + 1;
					}
					(ib(d).seriesIndex = t.seriesIndex), Oa(d, L, O, R);
					var z = fg(t.get('smooth')),
						B = t.get('smoothMonotone');
					if ((d.setShape({ smooth: z, smoothMonotone: B, connectNulls: S }), g)) {
						...
						g.useStyle(
							...
							Ea(g, t, 'areaStyle'),
							(ib(g).seriesIndex = t.seriesIndex),
							Oa(g, L, O, R);
					}
					var V = function (t) {
					...
					a.eachItemGraphicEl(function (t) {
						...
						(this._step = I),
						(this._valueOrigin = _),
						t.get('triggerLineEvent') && (this.packEventData(t, d), g && this.packEventData(t, g));
				}),
					...
					if ((this._changePolyState('emphasis'), !(o instanceof Array) && null != o && o >= 0)) {
						...
						if (!s) {
							...
							var h = t.get('zlevel') || 0,
								c = t.get('z') || 0;
							(s = new Bk(r, o)), (s.x = l), (s.y = u), s.setZ(h, c);
						...
						s.highlight();
					} else HT.prototype.highlight.call(this, t, e, n, i);
				}),
				(n.prototype.downplay = function (t, e, n, i) {
					...
					} else HT.prototype.downplay.call(this, t, e, n, i);
				}),
				...
				(n.prototype._newPolyline = function (t) {
					...
					return (
						...
						(e = new Gk({ shape: { points: t }, segmentIgnoreThreshold: 2, z2: 10 })),
				...
				(n.prototype._newPolygon = function (t, e) {
					...
					return (
						...
						(n = new Uk({ shape: { points: t, stackedOnPoints: e }, segmentIgnoreThreshold: 2 })),
							...
							if (n)
								if (r) {
									var g = n,
										v = e.pointToCoord(c);
									i
										? ((p = g.startAngle), (f = g.endAngle), (d = (-v[1] / 180) * Math.PI))
										: ((p = g.r0), (f = g.r), (d = v[0]));
								} else {
									var y = n;
									i
				...
				(n.prototype._initOrUpdateEndLabel = function (t, e, n) {
					...
					if (Mg(t)) {
						...
						s ||
							((s = this._endLabel = new Jw({ z2: 200 })),
							(s.ignoreClip = !0),
				...
				(n.prototype._doUpdateAnimation = function (t, e, n, i, r, o, a) {
					...
					if (
						(r &&
							((c = gg(h.current, n, r, a)),
							(p = gg(h.stackedOnCurrent, n, r, a)),
							(f = gg(h.next, n, r, a)),
							(d = gg(h.stackedOnNext, n, r, a))),
						pg(c, f) > 3e3 || (l && pg(p, d) > 3e3))
					)
						return (
							s.stopAnimation(),
							s.setShape({ points: f }),
							void (l && (l.stopAnimation(), l.setShape({ points: f, stackedOnPoints: d })))
						);
					...
					h.current !== c && (g.shape.__points = h.next),
						...
						l &&
							...
							l.stopAnimation(),
							ls(l, { shape: { stackedOnPoints: d } }, u),
			...
			return (
				...
				(n.prototype.updateData = function (t, e, n, i) {
					var r = this,
						...
						l = t.getItemLayout(e),
						u = h(Fg(a.getModel('itemStyle'), l, !0), l);
					...
					if (i) {
						...
						o.ecModel.ssr
							...
							: ((r.shape.endAngle = l.startAngle),
							  ls(r, { shape: { endAngle: l.endAngle } }, o, e));
					} else ds(r), ls(r, { shape: u }, o, e);
					...
					v && r.attr('cursor', v),
						...
						(r.ensureState('emphasis').shape = h(
							...
							Fg(s.getModel('itemStyle'), l)
						)),
						h(r.ensureState('select'), {
							x: d,
							y: g,
							shape: Fg(a.getModel(['select', 'itemStyle']), l)
						}),
						h(r.ensureState('blur'), { shape: Fg(a.getModel(['blur', 'itemStyle']), l) });
				...
				(n.prototype._updateLabel = function (t, e, n) {
					...
					if ('outside' !== h && 'outer' !== h) i.removeTextGuideLine();
						...
						c || ((c = new iS()), this.setTextGuideLine(c)),
							Ld(this, Od(r), { stroke: s, opacity: F(o.get(['lineStyle', 'opacity']), l, 1) });
					}
				}),
				n
			);
			...
			return (
				...
				(n.prototype.init = function (e) {
					t.prototype.init.apply(this, arguments),
						(this.legendVisualProvider = new Jk(pm(this.getData, this), pm(this.getRawData, this))),
				...
				(n.prototype.getInitialData = function () {
					return Vg(this, { coordDimensions: ['value'], encodeDefaulter: S(ql, this) });
				}),
		...
		iA = (function (t) {
			...
			return (
				...
				(n.prototype.getCoordSysModel = function () {
					return this.getReferringComponents('grid', Ex).models[0];
				}),
	...
	var rA = {
		...
		lA = c({ logBase: 10 }, aA),
		uA = { category: oA, value: aA, time: sA, log: lA },
		hA = { value: 1, category: 1, time: 1, log: 1 },
		cA = (function () {
			function t(t) {
		...
		fA = (function (t) {
			function n() {
				var e = (null !== t && t.apply(this, arguments)) || this;
				return (e.type = 'cartesian2d'), (e.dimensions = pA), e;
			}
			return (
				e(n, t),
				...
				(n.prototype.containZone = function (t, e) {
					var n = this.dataToPoint(t),
						...
						r = this.getArea(),
						o = new jm(n[0], n[1], i[0] - n[0], i[1] - n[1]);
			...
			return (
						...
						if (i) {
							for (var r = [], o = i - 1; o >= 0; o--) {
								var a = +n[o],
									...
									l = s.model,
									u = s.scale;
								Qp(u) && l.get('alignTicks') && null == l.get('interval')
									? r.push(s)
									: (Pf(u, l), Qp(u) && (e = s));
							}
							r.length &&
								(e || ((e = r.pop()), Pf(e.scale, e.model)),
								v(r, function (t) {
									Zg(t.scale, t.model, e.scale);
								}));
						}
					}
					var i = this._axesMap;
					...
					function i() {
						v(s, function (t) {
							var e = t.isHorizontal(),
								...
								i = t.inverse ? 1 : 0;
							t.setExtent(n[i], n[1 - i]), Jg(t, e ? a.x : a.y);
						});
					}
				...
				(t.prototype._findConvertTarget = function (t) {
					var e,
						n,
						i = t.seriesModel,
						r = t.xAxisModel || (i && i.getReferringComponents('xAxis', Ex).models[0]),
						o = t.yAxisModel || (i && i.getReferringComponents('yAxis', Ex).models[0]),
						a = t.gridModel,
						s = this._coordsList;
						...
						return function (n, i) {
							if (Kg(n, t)) {
								...
								'x' === e
									...
									(o[l] = !0);
								var u = new dA(e, Lf(n), [0, 0], n.get('type'), l),
									h = 'category' === u.type;
		...
		mA = (function () {
			function t(t, e) {
				...
				var n = new xx({ x: e.position[0], y: e.position[1], rotation: e.rotation });
			...
			return (
				...
				(t.prototype.add = function (t) {
					_A[t](this.opt, this.axisModel, this.group, this._transformGroup);
				}),
				...
				(t.innerTextLayout = function (t, e, n) {
					...
					return (
						Ji(o)
							...
							: ((r = 'middle'),
							  (i = o > 0 && yA > o ? (n > 0 ? 'right' : 'left') : n > 0 ? 'left' : 'right')),
		...
		_A = {
			axisLine: function (t, e, n, i) {
				...
				if (('auto' === r && t.handleAutoShown && (r = t.handleAutoShown('axisLine')), r)) {
					...
					if (null != f) {
						...
						C(f) && (f = [f, f]), (C(d) || D(d)) && (d = [d, d]);
						var g = dc(e.get(['axisLine', 'symbolOffset']) || 0, d),
							y = d[0],
							m = d[1];
						v(
							[
							...
							function (e, i) {
								if ('none' !== f[i] && null != f[i]) {
									var r = pc(f[i], -y / 2, -m / 2, y, m, c.stroke, !0),
										o = e.r + e.offset,
										a = u ? l : s;
									r.attr({
										rotation: e.rotate,
			...
			axisTickLabel: function (t, e, n, i) {
				var r = av(n, i, e, t),
					o = lv(n, i, e, t);
				if ((ev(e, o, r), sv(n, i, e, t.tickDirection), e.get(['axisLabel', 'hideOverlap']))) {
					var a = Rd(
						y(o, function (t) {
				...
				if (r) {
					var o,
						...
						p = [
							...
							rv(a) ? t.labelOffset + s * u : 0
						],
						f = e.get('nameRotate');
					null != f && (f = (f * yA) / 180);
					var d;
					rv(a)
						? (o = mA.innerTextLayout(t.rotation, null != f ? f : t.rotation, s))
						: ((o = tv(t.rotation, a, f || 0, h)),
						  (d = t.axisNameAvailableWidth),
						  null != d && ((d = Math.abs(d / Math.sin(o.rotation))), !isFinite(d) && (d = null)));
					var g = l.getFont(),
						v = e.get('nameTruncate', !0) || {},
						y = v.ellipsis,
						m = B(t.nameTruncateMaxWidth, v.maxWidth, d),
						_ = new Jw({
							x: p[0],
							y: p[1],
							rotation: o.rotation,
							silent: mA.isLabelSilent(e),
							style: Xs(l, {
								text: r,
								font: g,
								overflow: 'truncate',
					...
					if (
						...
						var x = mA.makeAxisEventDataBase(e);
						(x.targetType = 'axisName'), (x.name = r), (ib(_).eventData = x);
					}
		...
		bA = Lr(),
		SA = ['axisLine', 'axisTickLabel', 'axisName'],
		...
		TA = (function (t) {
			...
			return (
				...
				(n.prototype.render = function (e, n, i, r) {
					...
					if (((this._axisGroup = new xx()), this.group.add(this._axisGroup), e.get('show'))) {
								...
								h(
									{
										handleAutoShown: function () {
											for (var t = a.coordinateSystem.getCartesians(), n = 0; n < t.length; n++)
												if (Qp(t[n].getOtherAxis(e.axis).scale)) return !0;
											return !1;
										}
									},
									s
						...
						v(SA, l.add, l),
							...
							v(
								MA,
								function (t) {
									e.get([t, 'show']) && CA[t](this, this._axisGroup, e, a);
								},
								this
							);
				...
				(n.prototype.render = function (t, e, n) {
					if ((this.group.removeAll(), t.get('show'))) {
						var i = this.group,
							...
							l = new Jw({
								style: Xs(r, { text: t.get('text'), fill: r.getTextColor() }, { disableBox: !0 }),
								z2: 10
							}),
							u = l.getBoundingRect(),
							h = t.get('subtext'),
						...
						(l.silent = !p && !d),
							...
							f &&
								c.on('click', function () {
									Bl(f, '_' + t.get('subtarget'));
								}),
							(ib(l).eventData = ib(c).eventData =
								d ? { componentType: 'title', componentIndex: t.componentIndex } : null),
							i.add(l),
							h && i.add(c);
						var g = i.getBoundingRect(),
							v = t.getBoxLayoutParams();
						(v.width = g.width), (v.height = g.height);
						var y = Fl(v, { width: n.getWidth(), height: n.getHeight() }, t.get('padding'));
						a ||
	...
	var OA = function (t, e) {
			...
			return (
				...
				(n.prototype._updateSelector = function (t) {
					...
					e === !0 && (e = t.selector = ['all', 'inverse']),
						M(e) &&
							v(e, function (t, i) {
								C(t) && (t = { type: t }), (e[i] = l(t, OA(n, t.type)));
							});
				}),
				(n.prototype.optionUpdated = function () {
					...
					var i = this.get('data') || e,
						...
						o = y(
							...
							function (t) {
								return (
									(C(t) || D(t)) && (t = { name: t }),
									r.get(t.name) ? null : (r.set(t.name, !0), new YS(t, this, this.ecModel))
								);
							},
							this
						);
		...
		NA = (function (t) {
			...
			return (
				e(n, t),
				(n.prototype.init = function () {
					this.group.add((this._contentGroup = new BA())),
						this.group.add((this._selectorGroup = new BA())),
				...
				(n.prototype.render = function (t, e, n) {
					...
					if (((this._isFirstRender = !1), this.resetInner(), t.get('show', !0))) {
						...
						var l = t.getBoxLayoutParams(),
							...
							d = Fl(c({ width: f.width, height: f.height }, l), u, h);
						(this.group.x = d.x - f.x),
							(this.group.y = d.y - f.y),
							this.group.markRedraw(),
							this.group.add((this._backgroundEl = Mv(f, t)));
					}
				}),
							...
							function (r, o) {
								...
								if (!l.get(a))
									if (f) {
										...
										m
											.on('click', EA(Iv, a, null, i, c))
											.on('mouseover', EA(kv, f.name, null, i, c))
											.on('mouseout', EA(Av, f.name, null, i, c)),
											l.set(a, !0);
									} else
										n.eachRawSeries(function (n) {
											if (!l.get(a) && n.legendVisualProvider) {
												...
												g &&
													0 === g[3] &&
													((g[3] = 0.2), (f = h(h({}, f), { fill: Un(g, 'rgba') })));
												var v = this._createItem(n, a, o, r, e, t, {}, f, d, u, i);
												v
													.on('click', EA(Iv, null, a, i, c))
													.on('mouseover', EA(kv, null, a, i, c))
													.on('mouseout', EA(Av, null, a, i, c)),
													l.set(a, !0);
											}
										}, this);
							},
				...
				(n.prototype._createItem = function (t, e, n, i, r, o, a, s, l, u, h) {
					...
					var k = new Zw({ shape: _.getBoundingRect(), invisible: !0 }),
						A = i.getModel('tooltip');
					return (
						A.get('show') &&
							Ns({ el: k, componentModel: r, itemName: e, itemTooltipOption: A.option }),
						_.add(k),
				...
				(n.prototype.layoutInner = function (t, e, n, i, r, o) {
					...
					mM(t.get('orient'), a, t.get('itemGap'), n.width, n.height);
					var l = a.getBoundingRect(),
						u = [-l.x, -l.y];
					if ((s.markRedraw(), a.markRedraw(), r)) {
						mM('horizontal', s, t.get('selectorItemGap', !0));
		...
		FA = (function (t) {
			...
			return (
				...
				(n.prototype.init = function (e, n, i) {
					var r = Gl(e);
					t.prototype.init.call(this, e, n, i), Ev(this, e, r);
				}),
				(n.prototype.mergeOption = function (e, n) {
					t.prototype.mergeOption.call(this, e, n), Ev(this, this.option, e);
				}),
				(n.type = 'legend.scroll'),
				(n.defaultOption = el(RA.defaultOption, {
					scrollDataIndex: 0,
					pageButtonItemGap: 5,
					pageButtonGap: null,
			...
			return (
				...
				(n.prototype.init = function () {
					t.prototype.init.call(this),
						this.group.add((this._containerGroup = new VA())),
						this._containerGroup.add(this.getContentGroup()),
						this.group.add((this._controllerGroup = new VA()));
				}),
				(n.prototype.resetInner = function () {
				...
				(n.prototype.layoutInner = function (t, e, n, i, r, o) {
					var a = this.getSelectorGroup(),
						...
						c = HA[1 - l],
						p = GA[1 - l];
					r && mM('horizontal', a, t.get('selectorItemGap', !0));
				...
				(n.prototype._layoutContentAndController = function (t, e, n, i, r, o, a, s) {
					...
					mM(t.get('orient'), l, t.get('itemGap'), i ? n.width : null, i ? null : n.height),
						mM('horizontal', h, t.get('pageButtonItemGap', !0));
					...
					return (
						null != w.pageIndex &&
							ls(l, { x: w.contentPosition[0], y: w.contentPosition[1] }, f ? t : null),
				...
				(n.prototype._pageGo = function (t, e, n) {
					...
					null != i &&
						n.dispatchAction({ type: 'legendScroll', scrollDataIndex: i, legendId: e.id });
				}),
				(n.prototype._updatePageInfoView = function (t, e) {
					...
					v(['pagePrev', 'pageNext'], function (i) {
						...
						a &&
							(a.setStyle(
								'fill',
								o ? t.get('pageIconColor', !0) : t.get('pageIconInactiveColor', !0)
							),
					...
					for (var v = u + 1, y = g, m = g, _ = null; p >= v; ++v)
						(_ = e(h[v])),
							((!_ && m.e > y.s + o) || (_ && !n(_, y.s))) &&
								((y = m.i > y.i ? m : _),
								y && (null == d.pageNextDataIndex && (d.pageNextDataIndex = y.i), ++d.pageCount)),
							(m = _);
	...
	var UA = Lr(),
			...
			return (
				...
				(t.prototype._renderHandle = function (t) {
					if (!this._dragging && this.updateHandleTransform) {
						...
						this._handle ||
							...
							(i = this._handle =
								Os(r.get('icon'), {
									...
									onmousedown: YA(this._onHandleDragMove, this, 0, 0),
									drift: YA(this._onHandleDragMove, this),
									ondragend: YA(this._onHandleDragEnd, this)
								})),
							n.add(i)),
							Gv(i, e, !1),
							i.setStyle(
						...
						M(s) || (s = [s, s]),
							(i.scaleX = s[0] / 2),
							(i.scaleY = s[1] / 2),
							Uh(this, '_doDispatchAxisPointer', r.get('throttle') || 0, 'fixRate'),
				...
				(t.prototype._moveHandleToValue = function (t, e) {
					Nv(
						...
						this._handle,
						Hv(this.getHandleTransform(t, this._axisModel, this._axisPointerModel))
					);
				}),
				...
				(t.prototype.clear = function (t) {
					...
					e &&
						...
						Xh(this, '_doDispatchAxisPointer');
				}),
			...
			return (
				...
				(n.prototype.makeElOption = function (t, e, n, i, r) {
					var o = n.axis,
						a = o.grid,
						s = i.get('type'),
						l = $v(a, o).getOtherAxis(o).getGlobalExtent(),
				...
				(n.prototype.updateHandleTransform = function (t, e, n) {
					var i = n.axis,
						...
						a = $v(r, i).getOtherAxis(i).getGlobalExtent(),
						s = 'x' === i.dim ? 0 : 1,
						l = [t.x, t.y];
		...
		JA = (function (t) {
			...
			return (
				...
				(n.prototype.render = function (t, e, n) {
					...
					Jv('axisPointer', n, function (t, e, n) {
						'none' !== r &&
		...
		nP = xy(['transform', 'webkitTransform', 'OTransform', 'MozTransform', 'msTransform']),
		iP = xy(['webkitTransition', 'transition', 'OTransition', 'MozTransition', 'msTransition']),
		rP = wy(iP, 'transition'),
		oP = wy(nP, 'transform'),
		aP =
			'position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;' +
			(Uy.transform3dSupported ? 'will-change:transform;' : ''),
		sP = (function () {
			function t(t, e, n) {
				if (
					((this._show = !1),
				...
				ky(this._styleCoord, r, o, e.getWidth() / 2, e.getHeight() / 2),
			...
			return (
				...
				(t.prototype.show = function (t, e) {
					...
					n.innerHTML
						? (i.cssText =
								aP +
								Dy(t, !this._firstShow, this._longHide) +
								Cy(r[0], r[1], !0) +
								('border-color:' + zl(e) + ';') +
								(t.get('extraCssText') || '') +
				...
				(t.prototype.setContent = function (t, e, n, i, r) {
					...
					var a = '';
					if ((C(r) && 'item' === n.get('trigger') && !_y(n) && (a = My(n, i, r)), C(t)))
						o.innerHTML = t + a;
					else if (t) {
						(o.innerHTML = ''), M(t) || (t = [t]);
				...
				(t.prototype.moveTo = function (t, e) {
					...
					if ((ky(n, this._zr, this._appendToBody, t, e), null != n[0] && null != n[1])) {
						var i = this.el.style,
							r = Cy(n[0], n[1]);
						v(r, function (t) {
							i[t[0]] = t[1];
				...
				(t.prototype.hide = function () {
					...
					(e.visibility = 'hidden'),
						(e.opacity = '0'),
						Uy.transform3dSupported && (e.willChange = ''),
						(this._show = !1),
				...
				(t.prototype.hideLater = function (t) {
					!this._show ||
						...
						(t
							? ((this._hideDelay = t),
							  (this._show = !1),
							  (this._hideTimeout = setTimeout(pm(this.hide, this), t)))
							: this.hide());
				}),
		...
		lP = (function () {
			function t(t) {
				(this._show = !1),
					...
					(this._enterable = !0),
					(this._zr = t.getZr()),
					Ly(this._styleCoord, this._zr, t.getWidth() / 2, t.getHeight() / 2);
			}
			return (
				(t.prototype.update = function (t) {
				...
				(t.prototype.moveTo = function (t, e) {
					...
					if (n) {
						...
						Ly(i, this._zr, t, e), (t = i[0]), (e = i[1]);
						var r = n.style,
							o = Ay(r.borderWidth || 0),
							a = Py(r);
		...
		uP = new Zw({ shape: { x: -1, y: -1, width: 2, height: 2 } }),
		hP = (function (t) {
			function n() {
				var e = (null !== t && t.apply(this, arguments)) || this;
				return (e.type = n.type), e;
			...
			return (
				...
				(n.prototype.init = function (t, e) {
					if (!Uy.node && e.getDom()) {
						...
						this._tooltipContent =
							'richText' === i
								? new lP(e)
								: new sP(e.getDom(), e, { appendToBody: n.get('appendToBody', !0) });
					}
				}),
				(n.prototype.render = function (t, e, n) {
					if (!Uy.node && n.getDom()) {
						...
						i.update(t),
							...
							'richText' !== this._renderMode && t.get('transitionDuration')
								? Uh(this, '_updatePosition', 50, 'fixRate')
								: Xh(this, '_updatePosition');
					}
				}),
				...
				(n.prototype.manuallyShowTip = function (t, e, n, i) {
					if (i.from !== this.uid && !Uy.node && n.getDom()) {
						var r = Ry(i, n);
						this._ticket = '';
						...
						if (a) {
							...
							(l.x = i.x),
								(l.y = i.y),
								l.update(),
								(ib(l).tooltipConfig = { name: null, option: i.tooltip }),
				...
				(n.prototype.manuallyHideTip = function (t, e, n, i) {
					...
					this._tooltipModel && r.hideLater(this._tooltipModel.get('hideDelay')),
						...
						i.from !== this.uid && this._hide(Ry(i, n));
				}),
				...
				(n.prototype._showAxisTooltip = function (t, e) {
					var n = this._ecModel,
						...
						o = Oy([e.tooltipOption], i),
						a = this._renderMode,
						s = [],
						l = ph('section', { blocks: [], noHeader: !0 }),
						u = [],
						c = new RT();
					v(t, function (t) {
						v(t.dataByAxis, function (t) {
							...
							if (e && null != r) {
								var o = Yv(r, e.axis, n, t.seriesDataIndices, t.valueLabelOpt),
									p = ph('section', { header: o, noHeader: !W(o), sortBlocks: !0, blocks: [] });
								l.blocks.push(p),
									v(t.seriesDataIndices, function (l) {
										...
										if (!(g.dataIndex < 0)) {
											(g.axisDim = t.axisDim),
												...
												(g.axisId = t.axisId),
												(g.axisValue = Ef(e.axis, { value: r })),
												(g.axisValueLabel = o),
												(g.marker = c.makeTooltipMarker('item', zl(g.color), a));
											var v = Yu(f.formatTooltip(d, !0, null)),
												y = v.frag;
											if (y) {
												var m = Oy([f], i).get('valueFormatter');
					...
					var p = e.position,
						f = o.get('order'),
						d = mh(l, c, a, f, n.get('useUTC'), o.get('textStyle'));
					d && u.unshift(d);
					var g = 'richText' === a ? '\n\n' : '<br/>',
						y = u.join(g);
				...
				(n.prototype._showSeriesItemTooltip = function (t, e, n) {
					...
					if (null == g || 'item' === g) {
						...
						var m = Yu(s.formatTooltip(l, !1, u)),
							_ = d.get('order'),
				...
				(n.prototype._showComponentItemTooltip = function (t, e, n) {
					...
					var h = t.positionDefault,
						c = Oy(l, this._tooltipModel, h ? { position: h } : null),
						p = c.get('content'),
						f = Math.random() + '',
						d = new RT();
					...
					if (((this._ticket = ''), t.get('showContent') && t.get('show'))) {
						...
						if (h)
							if (C(h)) {
								...
								(c = h), v && (c = hl(g.axisValue, c, d)), (c = Ll(c, n, !0));
							} else if (T(h)) {
								var y = pm(function (e, i) {
									e === this._ticket &&
										(u.setContent(i, l, t, f, a), this._updatePosition(t, a, r, o, u, n, s));
								}, this);
				...
				(n.prototype._updatePosition = function (t, e, n, i, r, o, a) {
					...
					if (
						...
						var d = Fl(f, { width: s, height: l });
						(n = d.x), (i = d.y), (h = null), (c = null);
					} else if (C(e) && a) {
						var g = By(e, p, u, t.get('borderWidth'));
						(n = g[0]), (i = g[1]);
					} else {
						var g = Ey(n, i, r, s, l, h ? null : 20, c ? null : 20);
						(n = g[0]), (i = g[1]);
					}
					if (
						(h && (n -= Ny(h) ? u[0] / 2 : 'right' === h ? u[0] : 0),
						c && (i -= Ny(c) ? u[1] / 2 : 'bottom' === c ? u[1] : 0),
						_y(t))
					) {
						var g = zy(n, i, r, s, l);
						(n = g[0]), (i = g[1]);
				...
				(n.prototype.dispose = function (t, e) {
					!Uy.node &&
						e.getDom() &&
						(Xh(this, '_updatePosition'), this._tooltipContent.dispose(), oy('itemTooltip', e));
				}),
				(n.type = 'tooltip'),
				n
			);
	...
	Xf(Vy),
		...
		(t.disconnect = jI),
		(t.dispose = ap),
		(t.getInstanceByDom = sp),
		(t.getInstanceById = lp),
		(t.registerTheme = up),
		(t.registerPreprocessor = hp),
		(t.registerProcessor = cp),
		(t.registerPostInit = pp),
		(t.registerPostUpdate = fp),
		(t.registerUpdateLifecycle = dp),
		(t.registerAction = gp),
		(t.registerCoordinateSystem = vp),
		(t.getCoordinateSystemDimensions = yp),
		(t.registerLayout = mp),
		(t.registerVisual = _p),
		(t.registerLoading = wp),
		(t.setCanvasCreator = bp),
		(t.registerMap = Sp),
		(t.getMap = Mp),
		(t.registerTransform = KI),
		(t.dataTool = rD),
		(t.registerLocale = nl),
		(t.zrender = Cx),
		(t.matrix = Nm),
		...
		(t.SeriesModel = BT),
		(t.ChartView = HT),
		(t.extendComponentModel = yd),
		(t.extendComponentView = md),
		(t.extendSeriesModel = _d),
		(t.extendChartView = xd),
		(t.throttle = Wh),
		(t.use = Xf),
		(t.setPlatformAPI = r),
		(t.parseGeoJSON = td),
